...
public class GT_FuelLoader
    ...
    public void run() {
        ...
        ItemList.sNitricAcid = GT_Mod.gregtechproxy.addFluid("nitric.acid", "Nitric Acid ", Materials.NitricAcid, 1, 295, GT_OreDictUnificator.get(OrePrefixes.cell, Materials.NitricAcid, 1), ItemList.Cell_Empty.get(1, new Object[0]), 1000);
