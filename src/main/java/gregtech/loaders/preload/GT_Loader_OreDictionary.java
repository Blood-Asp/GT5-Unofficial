...
import gregtech.common.blocks.GT_Item_Casings2;
...
public class GT_Loader_OreDictionary
    ...
    public void run() {
        ...
        GT_OreDictUnificator.registerOre(OrePrefixes.block, Materials.CallistoIce, GT_ModHandler.getModItem("dreamcraft", "tile.CallistoColdIce", 1L, 0));
        ...
        GT_OreDictUnificator.registerOre(OrePrefixes.block, Materials.Ledox,  GT_ModHandler.getModItem("dreamcraft", "tile.Ledox", 1L, 0));
        ...
        GT_OreDictUnificator.registerOre(OrePrefixes.rod, Materials.Stone, com.dreammaster.item.ItemList.CobbleStoneRod.getIS());
        ...
        GT_OreDictUnificator.registerOre(OrePrefixes.rod, Materials.Voidmetal, com.dreammaster.item.ItemList.VoidRod.getIS());
        ...
        GT_OreDictUnificator.registerOre(OrePrefixes.block, Materials.Quantium, GT_ModHandler.getModItem("dreamcraft", "tile.Quantinum", 1L, 0));
        ...
        GT_OreDictUnificator.registerOre(OrePrefixes.ingot,  Materials.Adamantium, GT_ModHandler.getModItem("GalaxySpace", "items.ingots", 1L, 0));
        GT_OreDictUnificator.registerOre(OrePrefixes.ore,  Materials.Cobalt, GT_ModHandler.getModItem("GalaxySpace", "phobosblocks", 1L, 4));
        GT_OreDictUnificator.registerOre(OrePrefixes.ingot,  Materials.Cobalt, GT_ModHandler.getModItem("GalaxySpace", "items.ingots", 1L, 1));
        ...
        GT_OreDictUnificator.registerOre("craftingToolShears", GT_ModHandler.getModItem("ExtraUtilities", "shears", 1L, 0));

        GT_OreDictUnificator.registerOre(OrePrefixes.log, Materials.Wood, GT_ModHandler.getModItem("ForbiddenMagic", "TaintLog", 1L, 0));
        GT_OreDictUnificator.registerOre(OrePrefixes.plank, Materials.Wood, GT_ModHandler.getModItem("ForbiddenMagic", "TaintPlank", 1L, 0));
