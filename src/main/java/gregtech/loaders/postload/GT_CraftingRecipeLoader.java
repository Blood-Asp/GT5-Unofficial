...
//            GameRegistry.addRecipe(GT_OreDictUnificator.get(OrePrefixes.paper, Materials.Empty, 2), " C ", "SSS", " C ", 'S', GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Paper, 1), 'C', brick);
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.ModularElectric1Helmet.getWildcard(1), bits, new Object[]{"ACA", "BDB", 'A', OrePrefixes.stick.get(Materials.Aluminium), 'B', OrePrefixes.plateDouble.get(Materials.StainlessSteel), 'C', OrePrefixes.battery.get(Materials.Elite), 'D', OrePrefixes.ring.get(Materials.Lead)});
        GT_ModHandler.addCraftingRecipe(ItemList.ModularElectric1Chestplate.getWildcard(1), bits, new Object[]{"ADA", "BCB", "AAA", 'A', OrePrefixes.stick.get(Materials.Aluminium), 'B', OrePrefixes.plateDouble.get(Materials.StainlessSteel), 'C', OrePrefixes.battery.get(Materials.Elite),'D', OrePrefixes.ring.get(Materials.Lead)});
        GT_ModHandler.addCraftingRecipe(ItemList.ModularElectric1Leggings.getWildcard(1), bits, new Object[]{"BCB", "ADA", "ADA", 'A', OrePrefixes.stick.get(Materials.Aluminium), 'B', OrePrefixes.plateDouble.get(Materials.StainlessSteel), 'C', OrePrefixes.battery.get(Materials.Elite), 'D', OrePrefixes.ring.get(Materials.Lead)});
        GT_ModHandler.addCraftingRecipe(ItemList.ModularElectric1Boots.getWildcard(1), bits, new Object[]{"ADA", "BCB", "ADA", 'A', OrePrefixes.stick.get(Materials.Aluminium), 'B', OrePrefixes.plateDouble.get(Materials.StainlessSteel), 'C', OrePrefixes.battery.get(Materials.Elite), 'D', OrePrefixes.ring.get(Materials.Lead)});
