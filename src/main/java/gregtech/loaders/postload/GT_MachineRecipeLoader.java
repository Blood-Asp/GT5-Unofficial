...
//        GT_Values.RA.addAlloySmelterRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Rubber, 2), GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Copper, 1), GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Copper, 1), 100, 16);
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Iron, 1), ItemList.Cell_Empty.get(2, new Object[0]),  Materials.HydrochloricAcid.getFluid(2000), new FluidStack(ItemList.sIron3Chloride, 2000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2), 400, 30);
...
//        Field Generator
	...
	private void addRecipesApril2017ChemistryUpdate(){
        ...
        GT_Values.RA.addMultiblockChemicalRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(11)}, new FluidStack[]{Materials.Methane.getFluid(10000),  Materials.Water.getFluid(20000)}, new FluidStack[]{Materials.CarbonDioxide.getGas(10000), Materials.CarbonDioxide.getGas(80000)}, null, 600, 480);
