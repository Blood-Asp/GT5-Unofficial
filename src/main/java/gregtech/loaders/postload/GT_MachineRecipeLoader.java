...
public class GT_MachineRecipeLoader implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 4L), OrePrefixes.circuit.get(Materials.Basic), 4, GT_Values.NF, ItemList.Schematic.get(1L), 600, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 3L), OrePrefixes.circuit.get(Materials.Good), 2, GT_Values.NF, ItemList.Schematic.get(1L), 300, 30);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.StainlessSteel, 2L), OrePrefixes.circuit.get(Materials.Advanced), 1, GT_Values.NF, ItemList.Schematic.get(1L), 150, 48);
