...
//        GT_Values.RA.addArcFurnaceRecipe(ItemList.Block_IridiumTungstensteel.get(1, new Object[]{}), new ItemStack[]{ GT_OreDictUnificator.get(OrePrefixes.ingot,Materials.Bronze,4), GT_OreDictUnificator.get(OrePrefixes.dust,Materials.Stone,1)}, null, 160, 96);
        ...
        for (OrePrefixes tPrefix : Arrays.asList(new OrePrefixes[]{OrePrefixes.dust, OrePrefixes.dustSmall, OrePrefixes.dustTiny})) {
            ...
            //GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Copper, 3L), GT_OreDictUnificator.get(tPrefix, Materials.Barium, 2L), GT_OreDictUnificator.get(tPrefix, Materials.Yttrium, 1L), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.YttriumBariumCuprate, 6L * tPrefix.mMaterialAmount), (int) (600L * tPrefix.mMaterialAmount / 3628800L), 8000);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.EnderEye, 1), GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite, 4), Materials.TungstenSteel.getMolten(576), ItemList.Field_Generator_MV.get(1), 1800, 120);
        GT_Values.RA.addAssemblerRecipe(ItemList.QuantumEye.get(1), GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 4), Materials.NiobiumTitanium.getMolten(1152), ItemList.Field_Generator_HV.get(1), 1800, 480);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.NetherStar, 1),  ItemList.Tool_DataOrb.get(4L), Materials.HSSG.getMolten(1152), ItemList.Field_Generator_EV.get(1), 1800, 1920);
        GT_Values.RA.addAssemblerRecipe(ItemList.QuantumStar.get(1), CustomItemList.HighEnergyFlowCircuit.get(4L), Materials.HSSS.getMolten(1728), ItemList.Field_Generator_IV.get(1), 1800, 7680);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Silicon, 1L), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Plastic, 1L), ItemList.Empty_Board_Basic.get(1), 32, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Silicon, 2L), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Polytetrafluoroethylene, 1L), ItemList.Empty_Board_Elite.get(1), 32, 256);
        ...
        for (Materials tMat : Materials.VALUES) {
            if ((tMat.mStandardMoltenFluid != null) && (tMat.contains(SubTag.SOLDERING_MATERIAL))) {
                ...
                GT_Values.RA.addAssemblerRecipe(ItemList.Circuit_Board_Basic.get(1L), ItemList.Circuit_Basic.get(2L), tMat.getMolten(144L * tMultiplier / 4L), ItemList.Circuit_Good.get(1L), 32, 16);
        ...
        GT_Values.RA.addChemicalRecipe(ItemList.GelledToluene.get(4), GT_Values.NI, new FluidStack(ItemList.sNitrationMixture, 250), GT_Values.NF, GT_ModHandler.getIC2Item("industrialTnt", 1L), 80, 480);

        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1L), ItemList.Cell_Empty.get(1), Materials.NatruralGas.getGas(16000), Materials.Gas.getGas(16000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.HydricSulfide, 2L), 160);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1L), ItemList.Cell_Empty.get(1), Materials.SulfuricGas.getGas(16000), Materials.Gas.getGas(16000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.HydricSulfide, 2L), 160);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1L), ItemList.Cell_Empty.get(1), Materials.SulfuricNaphtha.getFluid(7000), Materials.Naphtha.getFluid(7000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.HydricSulfide, 2L), 160);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1L), ItemList.Cell_Empty.get(1), Materials.SulfuricLightFuel.getFluid(6000), Materials.LightFuel.getFluid(6000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.HydricSulfide, 2L), 160);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 1L), ItemList.Cell_Empty.get(1), Materials.SulfuricHeavyFuel.getFluid(4000), Materials.HeavyFuel.getFluid(4000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.HydricSulfide, 2L), 160);
        ...
        GT_Values.RA.addChemicalRecipe(ItemList.Cell_Water.get(2),                               null, Materials.HydricSulfide.getFluid(2000), Materials.SulfuricAcid.getFluid(3000), ItemList.Cell_Empty.get(2), 320);
        ...
        GT_Values.RA.addChemicalRecipe(ItemList.Cell_Air.get(7), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Naphtha, 1L),GT_Values.NF, Materials.Plastic.getMolten(500), ItemList.Cell_Empty.get(8), 2000);
        ...
        GT_Values.RA.addDistilleryRecipe(ItemList.Circuit_Integrated.getWithDamage(0L, 4L), Materials.Creosote.getFluid(90L), Materials.Lubricant.getFluid(30L), 240, 30, false);
        GT_Values.RA.addDistilleryRecipe(ItemList.Circuit_Integrated.getWithDamage(0L, 4L), Materials.SeedOil.getFluid(40L), Materials.Lubricant.getFluid(10L), 80, 30, false);
        GT_Values.RA.addDistilleryRecipe(ItemList.Circuit_Integrated.getWithDamage(0L, 4L), Materials.FishOil.getFluid(30L), Materials.Lubricant.getFluid(10L), 80, 30, false);
    ...
    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, 	Materials.Steel, 3L), 			GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Silicon, 1L), 	GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.ElectricalSteel, 4L), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.DarkAsh, 2L), (int) Math.max(Materials.ElectricalSteel.getMass() / 40L, 1L) * Materials.ElectricalSteel.mBlastFurnaceTemp, 120, Materials.ElectricalSteel.mBlastFurnaceTemp);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 	    Materials.TungstenSteel, 1L), 	ItemList.Circuit_Integrated.getWithDamage(0L, 1L, new Object[0]), 		GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.TungstenSteel, 1L), GT_Values.NI, (int) Math.max(Materials.TungstenSteel.getMass() /160L, 1L) * 3000, 480, 3000);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, 	Materials.TungstenSteel, 9L), 	ItemList.Circuit_Integrated.getWithDamage(0L, 9L, new Object[0]), 		GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.TungstenSteel, 1L), GT_Values.NI, (int) Math.max(Materials.TungstenSteel.getMass() /160L, 1L) * 3000, 480, 3000);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.TungstenSteel, 4L), 	ItemList.Circuit_Integrated.getWithDamage(0L, 4L, new Object[0]), 		GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.TungstenSteel, 1L), GT_Values.NI, (int) Math.max(Materials.TungstenSteel.getMass() /160L, 1L) * 3000, 480, 3000);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 	    Materials.TungstenSteel, 1L), 	ItemList.Circuit_Integrated.getWithDamage(0L,11L, new Object[0]), 		Materials.Nitrogen.getGas(1000L),                   GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.TungstenSteel, 1L), GT_Values.NI, (int) Math.max(Materials.TungstenSteel.getMass() /160L, 1L) * 2500, 480, 3000);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, 	Materials.TungstenSteel, 9L), 	ItemList.Circuit_Integrated.getWithDamage(0L,19L, new Object[0]), 		Materials.Nitrogen.getGas(1000L),                   GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.TungstenSteel, 1L), GT_Values.NI, (int) Math.max(Materials.TungstenSteel.getMass() /160L, 1L) * 2500, 480, 3000);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.TungstenSteel, 4L), 	ItemList.Circuit_Integrated.getWithDamage(0L,14L, new Object[0]), 		Materials.Nitrogen.getGas(1000L),                   GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.TungstenSteel, 1L), GT_Values.NI, (int) Math.max(Materials.TungstenSteel.getMass() /160L, 1L) * 2500, 480, 3000);
//
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 	    Materials.TungstenCarbide, 1L), ItemList.Circuit_Integrated.getWithDamage(0L, 1L, new Object[0]), 		GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.TungstenCarbide, 1L), GT_Values.NI, (int) Math.max(Materials.TungstenCarbide.getMass() / 40L, 1L) * 2460, 480, 2460);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, 	Materials.TungstenCarbide, 9L), ItemList.Circuit_Integrated.getWithDamage(0L, 9L, new Object[0]), 		GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.TungstenCarbide, 1L), GT_Values.NI, (int) Math.max(Materials.TungstenCarbide.getMass() / 40L, 1L) * 2460, 480, 2460);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.TungstenCarbide, 4L), ItemList.Circuit_Integrated.getWithDamage(0L, 4L, new Object[0]), 		GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.TungstenCarbide, 1L), GT_Values.NI, (int) Math.max(Materials.TungstenCarbide.getMass() / 40L, 1L) * 2460, 480, 2460);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 	    Materials.TungstenCarbide, 1L), ItemList.Circuit_Integrated.getWithDamage(0L,11L, new Object[0]), 		Materials.Nitrogen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.TungstenCarbide, 1L), GT_Values.NI, (int) Math.max(Materials.TungstenCarbide.getMass() / 40L, 1L) * 2000, 480, 2460);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, 	Materials.TungstenCarbide, 9L), ItemList.Circuit_Integrated.getWithDamage(0L,19L, new Object[0]), 		Materials.Nitrogen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.TungstenCarbide, 1L), GT_Values.NI, (int) Math.max(Materials.TungstenCarbide.getMass() / 40L, 1L) * 2000, 480, 2460);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.TungstenCarbide, 4L), ItemList.Circuit_Integrated.getWithDamage(0L,14L, new Object[0]), 		Materials.Nitrogen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.TungstenCarbide, 1L), GT_Values.NI, (int) Math.max(Materials.TungstenCarbide.getMass() / 40L, 1L) * 2000, 480, 2460);
//
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 	    Materials.VanadiumGallium, 1L), ItemList.Circuit_Integrated.getWithDamage(0L, 1L, new Object[0]),    	GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.VanadiumGallium, 1L), GT_Values.NI, (int) Math.max(Materials.VanadiumGallium.getMass() /160L, 1L) * 4500, 480, 4500);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, 	Materials.VanadiumGallium, 9L), ItemList.Circuit_Integrated.getWithDamage(0L, 9L, new Object[0]),    	GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.VanadiumGallium, 1L), GT_Values.NI, (int) Math.max(Materials.VanadiumGallium.getMass() /160L, 1L) * 4500, 480, 4500);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.VanadiumGallium, 4L), ItemList.Circuit_Integrated.getWithDamage(0L, 4L, new Object[0]),    	GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.VanadiumGallium, 1L), GT_Values.NI, (int) Math.max(Materials.VanadiumGallium.getMass() /160L, 1L) * 4500, 480, 4500);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 	    Materials.VanadiumGallium, 1L), ItemList.Circuit_Integrated.getWithDamage(0L,11L, new Object[0]),    	Materials.Helium.getGas(1000L),					    GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.VanadiumGallium, 1L), GT_Values.NI, (int) Math.max(Materials.VanadiumGallium.getMass() /160L, 1L) * 4000, 480, 4500);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, 	Materials.VanadiumGallium, 9L), ItemList.Circuit_Integrated.getWithDamage(0L,19L, new Object[0]),    	Materials.Helium.getGas(1000L),					    GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.VanadiumGallium, 1L), GT_Values.NI, (int) Math.max(Materials.VanadiumGallium.getMass() /160L, 1L) * 4000, 480, 4500);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.VanadiumGallium, 4L), ItemList.Circuit_Integrated.getWithDamage(0L,14L, new Object[0]),    	Materials.Helium.getGas(1000L),					    GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.VanadiumGallium, 1L), GT_Values.NI, (int) Math.max(Materials.VanadiumGallium.getMass() /160L, 1L) * 4000, 480, 4500);
//
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 	    Materials.NiobiumTitanium, 1L), ItemList.Circuit_Integrated.getWithDamage(0L, 1L, new Object[0]), 	    GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.NiobiumTitanium, 1L), GT_Values.NI, (int) Math.max(Materials.NiobiumTitanium.getMass() /160L, 1L) * 4500, 480, 4500);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, 	Materials.NiobiumTitanium, 9L), ItemList.Circuit_Integrated.getWithDamage(0L, 9L, new Object[0]), 	    GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.NiobiumTitanium, 1L), GT_Values.NI, (int) Math.max(Materials.NiobiumTitanium.getMass() /160L, 1L) * 4500, 480, 4500);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.NiobiumTitanium, 4L), ItemList.Circuit_Integrated.getWithDamage(0L, 4L, new Object[0]), 	    GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.NiobiumTitanium, 1L), GT_Values.NI, (int) Math.max(Materials.NiobiumTitanium.getMass() /160L, 1L) * 4500, 480, 4500);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 	    Materials.NiobiumTitanium, 1L), ItemList.Circuit_Integrated.getWithDamage(0L,11L, new Object[0]), 	    Materials.Helium.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.NiobiumTitanium, 1L), GT_Values.NI, (int) Math.max(Materials.NiobiumTitanium.getMass() /160L, 1L) * 4000, 480, 4500);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, 	Materials.NiobiumTitanium, 9L), ItemList.Circuit_Integrated.getWithDamage(0L,19L, new Object[0]), 	    Materials.Helium.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.NiobiumTitanium, 1L), GT_Values.NI, (int) Math.max(Materials.NiobiumTitanium.getMass() /160L, 1L) * 4000, 480, 4500);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.NiobiumTitanium, 4L), ItemList.Circuit_Integrated.getWithDamage(0L,14L, new Object[0]), 	    Materials.Helium.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.NiobiumTitanium, 1L), GT_Values.NI, (int) Math.max(Materials.NiobiumTitanium.getMass() /160L, 1L) * 4000, 480, 4500);
//
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 	    Materials.Nichrome, 1L), 		ItemList.Circuit_Integrated.getWithDamage(0L, 1L, new Object[0]), 		GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Nichrome, 1L), GT_Values.NI, (int) Math.max(Materials.Nichrome.getMass() /160L, 1L) * 2700, 480, 2700);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, 	Materials.Nichrome, 9L), 		ItemList.Circuit_Integrated.getWithDamage(0L, 9L, new Object[0]), 		GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Nichrome, 1L), GT_Values.NI, (int) Math.max(Materials.Nichrome.getMass() /160L, 1L) * 2700, 480, 2700);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Nichrome, 4L), 		ItemList.Circuit_Integrated.getWithDamage(0L, 4L, new Object[0]), 		GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Nichrome, 1L), GT_Values.NI, (int) Math.max(Materials.Nichrome.getMass() /160L, 1L) * 2700, 480, 2700);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 	    Materials.Nichrome, 1L), 		ItemList.Circuit_Integrated.getWithDamage(0L,11L, new Object[0]), 		Materials.Nitrogen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Nichrome, 1L), GT_Values.NI, (int) Math.max(Materials.Nichrome.getMass() /160L, 1L) * 2000, 480, 2700);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, 	Materials.Nichrome, 9L), 		ItemList.Circuit_Integrated.getWithDamage(0L,19L, new Object[0]), 		Materials.Nitrogen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Nichrome, 1L), GT_Values.NI, (int) Math.max(Materials.Nichrome.getMass() /160L, 1L) * 2000, 480, 2700);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Nichrome, 4L), 		ItemList.Circuit_Integrated.getWithDamage(0L,14L, new Object[0]), 		Materials.Nitrogen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Nichrome, 1L), GT_Values.NI, (int) Math.max(Materials.Nichrome.getMass() /160L, 1L) * 2000, 480, 2700);
//
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 		Materials.StainlessSteel, 1L), 	ItemList.Circuit_Integrated.getWithDamage(0L, 1L, new Object[0]), 		GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.StainlessSteel, 1L), GT_Values.NI, 1700, 480, 1700);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny,  Materials.StainlessSteel, 9L), 	ItemList.Circuit_Integrated.getWithDamage(0L, 9L, new Object[0]), 		GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.StainlessSteel, 1L), GT_Values.NI, 1700, 480, 1700);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.StainlessSteel, 4L), 	ItemList.Circuit_Integrated.getWithDamage(0L, 4L, new Object[0]), 		GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.StainlessSteel, 1L), GT_Values.NI, 1700, 480, 1700);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 		Materials.StainlessSteel, 1L), 	ItemList.Circuit_Integrated.getWithDamage(0L, 11L, new Object[0]), 		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.StainlessSteel, 1L), GT_Values.NI, 1200, 480, 1700);
        //GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, 	Materials.StainlessSteel, 9L), 	ItemList.Circuit_Integrated.getWithDamage(0L, 19L, new Object[0]), 		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.StainlessSteel, 1L), GT_Values.NI, 1200, 480, 1700);
        ...
        //!!!! UNDER ANY CIRCUMSTANCES DO NOT ENABLE THIS CODE OR ADD NEW RECIPES HERE, THIS FUNCTION IS TOO LONG !!!!


    //   GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 		Materials.Ruby, 1L), 			ItemList.Circuit_Integrated.getWithDamage(0L, 1L, new Object[0]), 		GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Aluminium, 3L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.DarkAsh, 1L), 400, 120, 1200);
    ...
    //    GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 		Materials.GreenSapphire, 1L), 	ItemList.Circuit_Integrated.getWithDamage(0L, 1L, new Object[0]), 		GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Aluminium, 3L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.DarkAsh, 1L), 400, 120, 1200);
    ...
    //    GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 		Materials.Sapphire, 1L), 		ItemList.Circuit_Integrated.getWithDamage(0L, 1L, new Object[0]), 		GT_Values.NF, 										GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Aluminium, 3L), GT_Values.NI, 400, 120, 1200);
    ...
    //    GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 		Materials.Magnesium, 2L), 		ItemList.Circuit_Integrated.getWithDamage(0L, 12L, new Object[0]), 		Materials.Titaniumtetrachloride.getFluid(1000L), 	GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Titanium, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Magnesiumchloride, 2L), 800, 480, 2140);

    //    GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 		Materials.Galena, 1L), 			ItemList.Circuit_Integrated.getWithDamage(0L, 11L, new Object[0]),		Materials.Oxygen.getGas(2000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Silver, 4L), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Lead, 4L), 400, 480, 1500);
    ...
    //    GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 		Materials.Magnetite, 1L), 		ItemList.Circuit_Integrated.getWithDamage(0L, 11L, new Object[0]),		Materials.Oxygen.getGas(2000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.WroughtIron, 4L), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.DarkAsh, 1L), 400, 480, 1000);
    ...
    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 		Materials.Iron, 1L), 			ItemList.Circuit_Integrated.getWithDamage(0L, 11L, new Object[0]),		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1L), GT_Values.NI, 500, 120, 1000);
    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, 	Materials.Iron, 9L), 			ItemList.Circuit_Integrated.getWithDamage(0L, 19L, new Object[0]),		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1L), GT_Values.NI, 500, 120, 1000);
    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Iron, 4L), 			ItemList.Circuit_Integrated.getWithDamage(0L, 14L, new Object[0]),		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1L), GT_Values.NI, 500, 120, 1000);

    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 		Materials.PigIron, 1L), 		ItemList.Circuit_Integrated.getWithDamage(0L, 11L, new Object[0]),		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1L), GT_Values.NI, 100, 120, 1000);
    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, 	Materials.PigIron, 9L), 		ItemList.Circuit_Integrated.getWithDamage(0L, 19L, new Object[0]),		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1L), GT_Values.NI, 100, 120, 1000);
    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.PigIron, 4L), 		ItemList.Circuit_Integrated.getWithDamage(0L, 14L, new Object[0]),		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1L), GT_Values.NI, 100, 120, 1000);

    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 		Materials.WroughtIron, 1L), 	ItemList.Circuit_Integrated.getWithDamage(0L, 11L, new Object[0]),		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1L), GT_Values.NI, 100, 120, 1000);
    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, 	Materials.WroughtIron, 9L), 	ItemList.Circuit_Integrated.getWithDamage(0L, 19L, new Object[0]),		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1L), GT_Values.NI, 100, 120, 1000);
    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.WroughtIron, 4L), 	ItemList.Circuit_Integrated.getWithDamage(0L, 14L, new Object[0]),		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1L), GT_Values.NI, 100, 120, 1000);

    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 		Materials.ShadowIron, 1L), 		ItemList.Circuit_Integrated.getWithDamage(0L, 11L, new Object[0]),		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.ShadowSteel, 1L), GT_Values.NI, 500, 120, 1100);
    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, 	Materials.ShadowIron, 9L), 		ItemList.Circuit_Integrated.getWithDamage(0L, 19L, new Object[0]),		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.ShadowSteel, 1L), GT_Values.NI, 500, 120, 1100);
    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.ShadowIron, 4L), 		ItemList.Circuit_Integrated.getWithDamage(0L, 14L, new Object[0]),		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.ShadowSteel, 1L), GT_Values.NI, 500, 120, 1100);

    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 		Materials.MeteoricIron, 1L), 	ItemList.Circuit_Integrated.getWithDamage(0L, 11L, new Object[0]),		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.MeteoricSteel, 1L), GT_Values.NI, 500, 120, 1200);
    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, 	Materials.MeteoricIron, 9L), 	ItemList.Circuit_Integrated.getWithDamage(0L, 19L, new Object[0]),		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.MeteoricSteel, 1L), GT_Values.NI, 500, 120, 1200);
    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.MeteoricIron, 4L), 	ItemList.Circuit_Integrated.getWithDamage(0L, 14L, new Object[0]),		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.MeteoricSteel, 1L), GT_Values.NI, 500, 120, 1200);

    //    GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 		Materials.Copper, 1L), 			ItemList.Circuit_Integrated.getWithDamage(0L, 11L, new Object[0]),		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.AnnealedCopper, 1L), GT_Values.NI, 500, 120, 1200);
    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, 	Materials.Copper, 1L), 			ItemList.Circuit_Integrated.getWithDamage(0L, 10L, new Object[0]),		Materials.Oxygen.getGas(1000L), 					GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.AnnealedCopper, 1L), GT_Values.NI, 500, 120, 1200);
    ...
    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, 		Materials.Osmiridium, 1L), 		ItemList.Circuit_Integrated.getWithDamage(0L, 11L, new Object[0]), 		Materials.Helium.getGas(1000), 						GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Osmiridium, 1L), null, 500, 1920, 4500);
    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, 	Materials.Osmiridium, 9L), 		ItemList.Circuit_Integrated.getWithDamage(0L, 19L, new Object[0]), 		Materials.Helium.getGas(1000), 						GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Osmiridium, 1L), null, 500, 1920, 4500);
    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Osmiridium, 4L), 		ItemList.Circuit_Integrated.getWithDamage(0L, 14L, new Object[0]), 		Materials.Helium.getGas(1000), 						GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Osmiridium, 1L), null, 500, 1920, 4500);
    ...
    //  GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, 	Materials.Naquadah, 1L), 		GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Osmiridium, 1L), Materials.Argon.getGas(1000), null, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.NaquadahAlloy, 2L), null, 500, 30720, Materials.NaquadahAlloy.mBlastFurnaceTemp);
        ...
        GT_Values.RA.addDistillationTowerRecipe(new FluidStack(FluidRegistry.getFluid("ic2biomass"), 250), new FluidStack[]{new FluidStack(FluidRegistry.getFluid("ic2biogas"), 7500), Materials.Water.getFluid(125L)}, ItemList.FR_Fertilizer.get(1), 150, 400);
        ...
        GT_Values.RA.addBenderRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.TungstenSteel, 6L), ItemList.RC_Rail_Reinforced.get(24L), 1200, 64);
        ...
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs1", 1L, 0), ItemList.Plank_Larch.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs1", 1L, 1), ItemList.Plank_Teak.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs1", 1L, 2), ItemList.Plank_Acacia_Green.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs1", 1L, 3), ItemList.Plank_Lime.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs1", 1L, 4), ItemList.Plank_Chestnut.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs1", 1L, 5), ItemList.Plank_Wenge.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs1", 1L, 6), ItemList.Plank_Baobab.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs1", 1L, 7), ItemList.Plank_Sequoia.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs2", 1L, 0), ItemList.Plank_Kapok.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs2", 1L, 1), ItemList.Plank_Ebony.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs2", 1L, 2), ItemList.Plank_Mahagony.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs2", 1L, 3), ItemList.Plank_Balsa.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs2", 1L, 4), ItemList.Plank_Willow.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs2", 1L, 5), ItemList.Plank_Walnut.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs2", 1L, 6), ItemList.Plank_Greenheart.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs2", 1L, 7), ItemList.Plank_Cherry.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs3", 1L, 0), ItemList.Plank_Mahoe.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs3", 1L, 1), ItemList.Plank_Poplar.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs3", 1L, 2), ItemList.Plank_Palm.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs3", 1L, 3), ItemList.Plank_Papaya.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs3", 1L, 4), ItemList.Plank_Pine.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs3", 1L, 5), ItemList.Plank_Plum.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs3", 1L, 6), ItemList.Plank_Maple.get(2L), GT_Values.NI, 50, 8);
        GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs3", 1L, 7), ItemList.Plank_Citrus.get(2L), GT_Values.NI, 50, 8);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.NaquadahAlloy, 2L), ItemList.Casing_UV.get(1L), Materials.Polytetrafluoroethylene.getMolten(288), ItemList.Hull_UV.get(1L), 50, 16);
...
//      Motor
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Motor_IV.get(1, new Object(){}),72000,new ItemStack[]{
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Samarium, 4L),
                GT_OreDictUnificator.get(OrePrefixes.stickLong, Materials.Iridium, 4L),
                GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Palladium, 2L),
                GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Naquadah, 64L),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Alduorite, 64L),
                ...
                Materials.Lubricant.getFluid(250)}, ItemList.Electric_Motor_LuV.get(1), 600, 32000);

        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Motor_LuV.get(1, new Object(){}),144000,new ItemStack[]{
                GT_OreDictUnificator.get(OrePrefixes.stickLong, Materials.Samarium, 4L),
                ...
                GT_OreDictUnificator.get(OrePrefixes.plateTriple, Materials.Vulcanite, 2L),
                GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Ceruclase, 3L),
                GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.NiobiumTitanium, 64L),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Vinteum, 64L),
                ...
                Materials.Lubricant.getFluid(750)}, ItemList.Electric_Motor_ZPM.get(1), 1200, 125000);

        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Motor_ZPM.get(1, new Object(){}),288000,new ItemStack[]{
                GT_OreDictUnificator.get(OrePrefixes.stickLong, Materials.Samarium, 8L),
                GT_OreDictUnificator.get(OrePrefixes.stickLong, Materials.Neutronium, 4L),
                GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Adamantium, 4L),
                GT_OreDictUnificator.get(OrePrefixes.round, Materials.Osmium, 16L),
                GT_OreDictUnificator.get(OrePrefixes.plateQuadruple, Materials.Trinium, 2L),
                GT_OreDictUnificator.get(OrePrefixes.plateTriple, Materials.Orichalcum, 3L),
                GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Rubracium, 4L),
                GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Ceruclase, 64L),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.HSSS, 64L),
                GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.ElectrumFlux, 4L)}, new FluidStack[]{
                Materials.Argon.getGas(5000),
                Materials.Polytetrafluoroethylene.getMolten(1296),
                Materials.SolderingAlloy.getMolten(1296),
                Materials.Lubricant.getFluid(2000)}, ItemList.Electric_Motor_UV.get(1), 1800, 500000);
...
//      Pump
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Pump_IV.get(1, new Object(){}),72000,new ItemStack[]{
        		...
        		GT_OreDictUnificator.get(OrePrefixes.screw, Materials.Palladium, 8L),
        		GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Polytetrafluoroethylene, 4L),
        		GT_OreDictUnificator.get(OrePrefixes.rotor, Materials.Alduorite, 2L),
        		GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.VanadiumGallium, 2L)}, new FluidStack[]{
                Materials.Rubber.getMolten(720),
        		Materials.SolderingAlloy.getMolten(288),
        		Materials.Lubricant.getFluid(250)}, ItemList.Electric_Pump_LuV.get(1), 600, 32000);
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Pump_LuV.get(1, new Object(){}),144000,new ItemStack[]{
        		...
        		GT_OreDictUnificator.get(OrePrefixes.screw, Materials.Vinteum, 16L),
        		GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Polytetrafluoroethylene, 8L),
        		GT_OreDictUnificator.get(OrePrefixes.rotor, Materials.HSSS, 4L),
        		GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.Naquadah, 2L)}, new FluidStack[]{
                Materials.Rubber.getMolten(1440),
        		Materials.SolderingAlloy.getMolten(576),
        		Materials.Lubricant.getFluid(750)}, ItemList.Electric_Pump_ZPM.get(1), 1200, 125000);
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Pump_ZPM.get(1, new Object(){}),288000,new ItemStack[]{
        		...
        		GT_OreDictUnificator.get(OrePrefixes.pipeHuge, Materials.Neutronium, 2L),
        		GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Osmium, 8L),
        		GT_OreDictUnificator.get(OrePrefixes.screw, Materials.Rubracium, 32L),
        		GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Polytetrafluoroethylene, 16L),
        		GT_OreDictUnificator.get(OrePrefixes.rotor, Materials.NaquadahAlloy, 8L),
        		GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.ElectrumFlux, 2L)}, new FluidStack[]{
                Materials.Glue.getFluid(2000),
                Materials.Rubber.getMolten(2880),
        		Materials.SolderingAlloy.getMolten(1296),
        		Materials.Lubricant.getFluid(2000)}, ItemList.Electric_Pump_UV.get(1), 1800, 500000);

//        Conveyor

        GT_Values.RA.addAssemblylineRecipe(ItemList.Conveyor_Module_IV.get(1, new Object(){}),72000,new ItemStack[]{
        		ItemList.Electric_Motor_LuV.get(2, new Object(){}),
        		GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Alduorite, 2L),
        		GT_OreDictUnificator.get(OrePrefixes.ring, Materials.HSSE, 4L),
        		GT_OreDictUnificator.get(OrePrefixes.round, Materials.Chrome, 32L),
        		GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.VanadiumGallium, 2L)}, new FluidStack[]{
        		Materials.Rubber.getMolten(720),
        		Materials.Lubricant.getFluid(500)}, ItemList.Conveyor_Module_LuV.get(1), 600, 32000);
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Conveyor_Module_LuV.get(1, new Object(){}),144000,new ItemStack[]{
        		...
        		GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Ceruclase, 4L),
        		GT_OreDictUnificator.get(OrePrefixes.ring, Materials.HSSS, 8L),
        		GT_OreDictUnificator.get(OrePrefixes.round, Materials.Iridium, 48L),
        		GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.NaquadahAlloy, 4L)}, new FluidStack[]{
        		Materials.Rubber.getMolten(1440),
                Materials.Polytetrafluoroethylene.getMolten(576),
        		Materials.Lubricant.getFluid(1000)}, ItemList.Conveyor_Module_ZPM.get(1), 1200, 125000);
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Conveyor_Module_ZPM.get(1, new Object(){}),288000,new ItemStack[]{
        		...
        		GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Adamantium, 8L),
        		GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Neutronium, 16L),
        		GT_OreDictUnificator.get(OrePrefixes.round, Materials.Osmium, 64L),
        		GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.ElectrumFlux, 8L)}, new FluidStack[]{
                Materials.Glue.getFluid(2000),
        		Materials.Rubber.getMolten(2880),
                Materials.Polytetrafluoroethylene.getMolten(1296),
        		Materials.Lubricant.getFluid(2000)}, ItemList.Conveyor_Module_UV.get(1), 1800, 500000);

//        Piston

        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Piston_IV.get(1, new Object(){}),72000,new ItemStack[]{
        		ItemList.Electric_Motor_LuV.get(1, new Object(){}),
        		GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Alduorite, 6L),
        		GT_OreDictUnificator.get(OrePrefixes.ring, Materials.HSSE, 4L),
        		...
        		GT_OreDictUnificator.get(OrePrefixes.gear, Materials.Chrome, 1L),
        		GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.Chrome, 2L),
                GT_OreDictUnificator.get(OrePrefixes.spring, Materials.Chrome, 2L),
        		GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.VanadiumGallium, 4L)}, new FluidStack[]{
                Materials.Water.getFluid(10000),
        		Materials.SolderingAlloy.getMolten(288),
        		Materials.Lubricant.getFluid(500)}, ItemList.Electric_Piston_LuV.get(1), 600, 32000);


        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Piston_LuV.get(1, new Object(){}),144000,new ItemStack[]{
        		ItemList.Electric_Motor_ZPM.get(1, new Object(){}),
        		GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Ceruclase, 8L),
        		GT_OreDictUnificator.get(OrePrefixes.ring, Materials.HSSS, 8L),
        		GT_OreDictUnificator.get(OrePrefixes.round, Materials.HSSS, 48L),
        		GT_OreDictUnificator.get(OrePrefixes.stick, Materials.HSSS, 8L),
        		GT_OreDictUnificator.get(OrePrefixes.gear, Materials.Iridium, 2L),
        		GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.Iridium, 4L),
                GT_OreDictUnificator.get(OrePrefixes.spring, Materials.Iridium, 4L),
        		GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.NaquadahAlloy, 4L)}, new FluidStack[]{
                Materials.Water.getFluid(10000),
        		Materials.SolderingAlloy.getMolten(576),
        		Materials.Lubricant.getFluid(1000)}, ItemList.Electric_Piston_ZPM.get(1), 1200, 125000);

        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Piston_ZPM.get(1, new Object(){}),288000,new ItemStack[]{
        		ItemList.Electric_Motor_UV.get(1, new Object(){}),
        		GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Adamantium, 10L),
        		GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Neutronium, 16L),
        		GT_OreDictUnificator.get(OrePrefixes.round, Materials.Neutronium, 64L),
        		GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Neutronium, 16L),
        		GT_OreDictUnificator.get(OrePrefixes.gear, Materials.Osmiridium, 4L),
        		GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.Osmium, 8L),
...
//        RobotArm
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Robot_Arm_IV.get(1, new Object(){}),72000,new ItemStack[]{
        		...
        		GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.HSSE, 4L),
        		ItemList.Electric_Motor_LuV.get(2, new Object(){}),
                ...
                GT_OreDictUnificator.get(OrePrefixes.spring, Materials.HSSG, 8L),
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.HSSG, 4L),
                GT_OreDictUnificator.get(OrePrefixes.gear, Materials.Chrome, 1L),
                GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.Chrome, 2L),
        		GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.VanadiumGallium, 6L)}, new FluidStack[]{
                Materials.Silicon.getMolten(1440),
        		Materials.SolderingAlloy.getMolten(576),
        		Materials.Lubricant.getFluid(250)}, ItemList.Robot_Arm_LuV.get(1), 600, 64000);

        GT_Values.RA.addAssemblylineRecipe(ItemList.Robot_Arm_LuV.get(1, new Object(){}),144000,new ItemStack[]{
        		GT_OreDictUnificator.get(OrePrefixes.stickLong, Materials.HSSS, 6L),
        		GT_OreDictUnificator.get(OrePrefixes.gear, Materials.HSSS, 2L),
        		GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.HSSS, 6L),
        		ItemList.Electric_Motor_ZPM.get(2, new Object(){}),
        		//ItemList.Electric_Piston_ZPM.get(1, new Object(){}),
                CustomItemList.PikoCircuit.get(2L),
                CustomItemList.NanoCircuit.get(2L),
                GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 2L),
                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Ceruclase, 8L),
                GT_OreDictUnificator.get(OrePrefixes.ring, Materials.HSSS, 8L),
                GT_OreDictUnificator.get(OrePrefixes.spring, Materials.HSSS, 16L),
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.HSSS, 8L),
                GT_OreDictUnificator.get(OrePrefixes.gear, Materials.Iridium, 2L),
                GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.Iridium, 4L),
        		GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.NaquadahAlloy, 8L)}, new FluidStack[]{
                Materials.Silicon.getMolten(1440),
        		Materials.SolderingAlloy.getMolten(1152),
        		Materials.Lubricant.getFluid(750)}, ItemList.Robot_Arm_ZPM.get(1), 1200, 250000);

        GT_Values.RA.addAssemblylineRecipe(ItemList.Robot_Arm_ZPM.get(1, new Object(){}),288000,new ItemStack[]{
        		GT_OreDictUnificator.get(OrePrefixes.stickLong, Materials.Neutronium, 9L),
        		GT_OreDictUnificator.get(OrePrefixes.gear, Materials.Neutronium, 3L),
        		GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.Neutronium, 9L),
        		ItemList.Electric_Motor_UV.get(2, new Object(){}),
        		//ItemList.Electric_Piston_UV.get(1, new Object(){}),
                CustomItemList.QuantumCircuit.get(2L),
                CustomItemList.PikoCircuit.get(2L),
                CustomItemList.NanoCircuit.get(2L),
                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Adamantium, 10L),
                GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Neutronium, 16L),
                GT_OreDictUnificator.get(OrePrefixes.spring, Materials.Neutronium, 32L),
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Neutronium, 16L),
                GT_OreDictUnificator.get(OrePrefixes.gear, Materials.Osmiridium, 4L),
                GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.Osmium, 8L),
        		GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.ElectrumFlux, 10L)}, new FluidStack[]{
                Materials.Glass.getMolten(1440),
                Materials.Silicon.getMolten(1440),
        		Materials.SolderingAlloy.getMolten(2304),
        		Materials.Lubricant.getFluid(2000)}, ItemList.Robot_Arm_UV.get(1), 2100, 1000000);
...
//        Emitter
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Emitter_IV.get(1, new Object(){}),72000,new ItemStack[]{
        		GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Alduorite, 1L),
        		//ItemList.Emitter_IV.get(1, new Object(){}),
                ItemList.Electric_Motor_LuV.get(1L, new Object(){}),
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Palladium, 8L),
                GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.Topaz, 1L),
                GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.BlueTopaz, 1L),
                CustomItemList.NanoCircuit.get(4L),
        		GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Palladium, 64L),
        		GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Naquadah, 64L),
        		...
        		Materials.SolderingAlloy.getMolten(576)},
        		ItemList.Emitter_LuV.get(1), 600, 64000);
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Emitter_LuV.get(1, new Object(){}),144000,new ItemStack[]{
                ...
                ItemList.Electric_Motor_ZPM.get(1L, new Object(){}),
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Vinteum, 16L),
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Vulcanite, 16L),
                GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.Jasper, 1L),
                GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.Amethyst, 1L),
                CustomItemList.PikoCircuit.get(6L),
                GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Niobium, 64L),
        		GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Mithril, 64L),
        		GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Ceruclase, 64L),
        		GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.NaquadahAlloy, 64L),
        		GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.NaquadahAlloy, 10L)}, new FluidStack[]{
        		Materials.SolderingAlloy.getMolten(1152)},
        		ItemList.Emitter_ZPM.get(1), 1200, 250000);
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Emitter_ZPM.get(1, new Object(){}),288000,new ItemStack[]{
                ...
                ItemList.Electric_Motor_UV.get(1L, new Object(){}),
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Europium, 32L),
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Yttrium, 32L),
                ...
                GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Realgar, 64L),
                GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Chrysotile, 64L),
        		GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Neutronium, 64L),
        		GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.BlackPlutonium, 64L),
        		GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.ElectrumFlux, 12L)}, new FluidStack[]{
        		Materials.SolderingAlloy.getMolten(2304)},
        		ItemList.Emitter_UV.get(1), 2100, 1000000);

//        Sensor

        GT_Values.RA.addAssemblylineRecipe(ItemList.Sensor_IV.get(1, new Object(){}),72000,new ItemStack[]{
                GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Ceruclase, 2L),
                //ItemList.Emitter_LuV.get(1, new Object(){}),
                ItemList.Electric_Motor_LuV.get(1L, new Object(){}),
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Vinteum, 16L),
                ...
                GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.BlueTopaz, 1L),
                CustomItemList.NanoCircuit.get(4L),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Palladium, 64L),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Naquadah, 64L),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.YttriumBariumCuprate, 64L),
        		GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.VanadiumGallium, 8L)}, new FluidStack[]{
        		Materials.SolderingAlloy.getMolten(576)},
        		ItemList.Sensor_LuV.get(1), 600, 64000);
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Sensor_LuV.get(1, new Object(){}),144000,new ItemStack[]{
                ...
                GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.Amethyst, 1L),
                CustomItemList.PikoCircuit.get(6L),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Niobium, 64L),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Mithril, 64L),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Ceruclase, 64L),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.NaquadahAlloy, 64L),
        		GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.NaquadahAlloy, 10L)}, new FluidStack[]{
        		Materials.SolderingAlloy.getMolten(1152)},
        		ItemList.Sensor_ZPM.get(1), 1200, 250000);
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Sensor_ZPM.get(1, new Object(){}),288000,new ItemStack[]{
                ...
                GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.GarnetYellow, 1L),
                CustomItemList.QuantumCircuit.get(8L),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Realgar, 64L),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Chrysotile, 64L),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Neutronium, 64L),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.BlackPlutonium, 64L),
        		GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.ElectrumFlux, 12L)}, new FluidStack[]{
        		Materials.SolderingAlloy.getMolten(2304)},
        		ItemList.Sensor_UV.get(1), 2100, 1000000);
...
//        Field Generator
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Field_Generator_IV.get(1, new Object(){}),72000,new ItemStack[]{
        		...
        		GT_OreDictUnificator.get(OrePrefixes.plateQuadruple, Materials.Naquadah, 4L),
        		CustomItemList.MysteriousCrystal.get(4L, new Object(){}),
                //GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Ceruclase, 2L),
                //ItemList.Emitter_LuV.get(1, new Object(){}),
                ItemList.Robot_Arm_LuV.get(1L, new Object(){}),
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Vinteum, 16L),
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Vulcanite, 16L),
                GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.Topaz, 1L),
                GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.BlueTopaz, 1L),
                CustomItemList.NanoCircuit.get(4L),
                GT_OreDictUnificator.get(OrePrefixes.springSmall, Materials.Palladium, 64L),
                GT_OreDictUnificator.get(OrePrefixes.springSmall, Materials.Naquadah, 64L),
                GT_OreDictUnificator.get(OrePrefixes.springSmall, Materials.YttriumBariumCuprate, 64L),
                GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.VanadiumGallium, 8L)}, new FluidStack[]{
        		Materials.SolderingAlloy.getMolten(576)},
        		ItemList.Field_Generator_LuV.get(1), 600, 64000);

        GT_Values.RA.addAssemblylineRecipe(ItemList.Field_Generator_LuV.get(1, new Object(){}),144000,new ItemStack[]{
        		GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Adamantium, 1L),
        		GT_OreDictUnificator.get(OrePrefixes.plateDense, Materials.NaquadahAlloy, 4L),
                CustomItemList.ManyullynCrystal.get(8L),
                //GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Ceruclase, 2L),
                //ItemList.Emitter_LuV.get(1, new Object(){}),
                ItemList.Robot_Arm_ZPM.get(1L, new Object(){}),
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Vinteum, 16L),
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Vulcanite, 16L),
                GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.Jasper, 1L),
                GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.Amethyst, 1L),
                CustomItemList.PikoCircuit.get(6L),
                GT_OreDictUnificator.get(OrePrefixes.springSmall, Materials.Niobium, 64L),
                GT_OreDictUnificator.get(OrePrefixes.springSmall, Materials.Mithril, 64L),
                GT_OreDictUnificator.get(OrePrefixes.springSmall, Materials.Ceruclase, 64L),
                GT_OreDictUnificator.get(OrePrefixes.springSmall, Materials.NaquadahAlloy, 64L),
                GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.NaquadahAlloy, 10L)}, new FluidStack[]{
        		Materials.SolderingAlloy.getMolten(1152)},
        		ItemList.Field_Generator_ZPM.get(1), 1200, 250000);
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Field_Generator_ZPM.get(1, new Object(){}),288000,new ItemStack[]{
        		...
        		GT_OreDictUnificator.get(OrePrefixes.plateQuintuple, Materials.BlackPlutonium, 4L),
                ItemList.Gravistar.get(16L),
                //GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Adamantium, 4L),
                //ItemList.Emitter_ZPM.get(1, new Object(){}),
                ItemList.Robot_Arm_UV.get(1L, new Object(){}),
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Europium, 32L),
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Yttrium, 32L),
                GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.GarnetRed, 1L),
                GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.GarnetYellow, 1L),
                ...
                GT_OreDictUnificator.get(OrePrefixes.springSmall, Materials.Adamantium, 64L),
                GT_OreDictUnificator.get(OrePrefixes.springSmall, Materials.Plutonium, 64L),
                GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.ElectrumFlux, 12L)}, new FluidStack[]{
        		Materials.SolderingAlloy.getMolten(2304)},
        		ItemList.Field_Generator_UV.get(1), 2100, 1000000);
