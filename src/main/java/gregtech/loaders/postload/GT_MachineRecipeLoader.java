...
//TODO CHECK Circuit Recipes!!!
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Circuit_Parts_Resistor.get(1, o), new Object[]{" P ","FCF"," P ", 'F',OrePrefixes.wireGt01.get(Materials.Copper),'P',OrePrefixes.wireFine.get(Materials.Copper), OrePrefixes.dust.get(Materials.Coal)});
