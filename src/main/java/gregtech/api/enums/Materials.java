...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials Aluminiumoxide          = new Materials( 696, TextureSet.SET_QUARTZ            ,1.0F,     64,  1,    1      |8    |64|128      , 255, 255, 255,   0,   "AluminiumOxide"   ,   "Alumina"  ,    0,       0,        2054,    2054, false, false,   1,   1,   1, Dyes.dyeWhite       , 2, Arrays.asList(new MaterialStack(Aluminium, 2), new MaterialStack(Oxygen, 3)), Arrays.asList(new TC_AspectStack(TC_Aspects.GELUM, 2)));
    public static Materials Aluminiumhydroxide      = new Materials( 697, TextureSet.SET_QUARTZ            ,1.0F,     64,  1,    1      |8    |64|128      , 255, 255, 255,   0,   "AluminiumHydroxide"   ,   "Aluminium Hydroxide"  ,    0,       0,        1200,    1200, false, false,   1,   1,   1, Dyes.dyeWhite       , 2, Arrays.asList(new MaterialStack(Aluminium, 1), new MaterialStack(HydrochloricAcid, 3)), Arrays.asList(new TC_AspectStack(TC_Aspects.GELUM, 2)));
    public static Materials Cryolite                = new Materials( 695, TextureSet.SET_QUARTZ            ,1.0F,     64,  1,    1      |8    |64|128      , 191, 239, 255,   0,   "Cryolite"   ,   "Cryolite"  ,    0,       0,        1012,    1012, false, false,   1,   1,   1, Dyes.dyeLightBlue       , 2, Arrays.asList(new MaterialStack(Sodium, 3), new MaterialStack(Aluminium, 1), new MaterialStack(Fluorine, 6)), Arrays.asList(new TC_AspectStack(TC_Aspects.GELUM, 2)));
