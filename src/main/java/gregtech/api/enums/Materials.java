...
//  public static Materials SaltWater               = new Materials(  -1, TextureSet.SET_FLUID             ,   1.0F,      0,  0,         16                ,   0,   0, 255,   0,   "SaltWater"               ,   "Salt Water"                    ,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyeBlue        , 0, Arrays.asList(new MaterialStack(Hydrogen, 2), new MaterialStack(Oxygen, 1)), Arrays.asList(new TC_AspectStack(TC_Aspects.AQUA, 2)));
    ...
    public static Materials EnrichedNaquadria       = new MaterialBuilder(601, TextureSet.SET_FLUID      ,                                                                                                     "Fluid Naquadah Fuel,").setName("FluidNaquadahFuel").addCell().addFluid().setRGB(97, 147, 46).setColor(Dyes.dyeLime).constructMaterial();
    public static Materials FluidNaquadaFuel        = new MaterialBuilder(602, TextureSet.SET_FLUID      ,                                                                                                     "Enriched Naquadria").setName("EnrichedNaquadria").addCell().addFluid().setRGB(97, 147, 46).setColor(Dyes.dyeLime).constructMaterial();
