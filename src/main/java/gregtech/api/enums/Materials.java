...
public enum Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    Ardite              ( 382, TextureSet.SET_METALLIC         ,   18.0F,   1024,  4, 1|2  |8      |64|128                  , 250, 129,   0,   0,   "Ardite"                        ,    0,       0,       1600, 1600,  true,  false,  1,   1,   1, Dyes.dyeRed         ),
...
// 	RyuDragonRyder		(  -1, TextureSet.SET_NONE				,   1.0F,      0,  1, 0                                     , 255, 255, 255,   0,	"Ryu Dragon Ryder"				,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	...
	Manyullyn			( 386, TextureSet.SET_METALLIC			,  25.0F,   2048,  5, 1|2  |8   |32|64|128                  , 154,  76, 185,   0,	"Manyullyn"						,    0,       0,       2500, 2500, true,  false,   1,   1,   1, Dyes.dyePurple		, 2, Arrays.asList(new MaterialStack(Cobalt, 1), new MaterialStack(Aredrite, 1)), Arrays.asList(new TC_AspectStack(TC_Aspects.STRONTIO, 2))),
