...
//\/HAD TO MOVE DOWN SECTION
    ...
    public static Materials CrystallinePinkSlime    = new Materials( 406, TextureSet.SET_METALLIC          ,   6.0F,    128,  3, 1|2          |64|128      , 184, 111, 172,   0,   "CrystallinePinkSlime"    ,   "Crystalline Pink Slime"        ,    0,       0,         -1, 1800,  true, false,   4,   1,   1, Dyes.dyePink        , 1, Arrays.asList(new MaterialStack(CrystallineAlloy, 1), new MaterialStack(Diamond, 1))).disableAutoGeneratedBlastFurnaceRecipes();
