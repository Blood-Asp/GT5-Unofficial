...
////public static Materials RefinedObsidian         = new Materials(----, TextureSet.SET_METALLIC          ,   1.0F,      0,  1, 1|2                       ,  80,  50, 100,   0,   "RefinedObsidian"         ,   "Refined Obsidian"              ,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyePurple      );
    ...
    public static Materials InfinityCatalyst        = new Materials( 394, TextureSet.SET_SHINY             , 256.0F,1310720,  7, 1|2    |8    |64|128      , 255, 255, 255,   0,   "InfinityCatalyst"        ,   "Infinity Catalyst"             ,     5,  500000,     10800,  10800,  true, false, 20,   1,   1, Dyes.dyeLightGray    );
    public static Materials Infinity                = new Materials( 397, TextureSet.SET_SHINY             , 512.0F,2621440,  8, 1|2    |8    |64|128      , 255, 255, 255,   0,   "Infinity"                ,   "Infinity"                      ,     5, 5000000,     10800,  10800,  true, false, 40,   1,   1, Dyes.dyeWhite        );
