...
//\/public static Materials BlueAlloy               = new Materials( 309, TextureSet.SET_DULL              ,   1.0F,      0,  0, 1|2                       , 100, 180, 255,   0,   "BlueAlloy"               ,   "Blue Alloy"                    ,    0,       0,         -1,    0, false, false,   3,   5,   1, Dyes.dyeLightBlue   , 2, Arrays.asList(new MaterialStack(Silver, 1), new MaterialStack(Electrotine, 4)), Arrays.asList(new TC_AspectStack(TC_Aspects.ELECTRUM, 3)));
    ...
    public static Materials PotassiumHydroxide     = new MaterialBuilder(590, TextureSet.SET_DULL       ,                                                                                                     "Potassium Hydroxide").setName("PotassiumHydroxide").addDustItems().setRGB(129, 34, 141).setColor(Dyes.dyePurple).setMaterialList(new MaterialStack(Potassium, 1), new MaterialStack(Oxygen, 1), new MaterialStack(Hydrogen, 1)).addElectrolyzerRecipe().constructMaterial();
    public static Materials ManganeseDioxide = new MaterialBuilder(591, TextureSet.SET_DULL       ,                                                                                                     "Manganese Dioxide").setName("Manganesedioxide").addDustItems().setRGB(255, 228, 225).setColor(Dyes.dyePink).setMaterialList(new MaterialStack(Manganese, 1), new MaterialStack(Oxygen, 2)).addElectrolyzerRecipe().constructMaterial();
    ...
    public static Materials PotassiumPermanganate = new MaterialBuilder(594, TextureSet.SET_DULL       ,                                                                                                     "Potassium Permanganate").setName("PotassiumPermanganate").addDustItems().setRGB(255, 8, 127).setColor(Dyes.dyePink).setMaterialList(new MaterialStack(Potassium, 1), new MaterialStack(Manganese, 1), new MaterialStack(Oxygen, 4)).addElectrolyzerRecipe().constructMaterial();
