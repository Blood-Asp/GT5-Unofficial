...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials BioFuel = new Materials(705, TextureSet.SET_FLUID, 		1.0F, 0, 0, 16, 255, 128, 0, 0, "BioFuel", "Bio Diesel", 0, 192, -1, 0, false, false, 1, 1, 1, Dyes.dyeOrange).setHasCorrespondingFluid(true);
