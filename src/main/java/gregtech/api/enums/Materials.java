...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials Tantalum                = new Materials(  80, TextureSet.SET_METALLIC          ,   1.0F,      0,  2, 1|2  |8   |32             , 221, 239, 255,   0,   "Tantalum"                ,   "Tantalum"                      ,    0,       0,       3290,    0, false, false,   4,   1,   1, Dyes._NULL          , Element.Ta        , Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.VINCULUM, 1)));
