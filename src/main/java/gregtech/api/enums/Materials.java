...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials Phosphorus_NEW = new Materials(21, TextureSet.SET_DULL, 		1.0F, 0, 2, 1|32, 255, 255, 0, 0, "Phosphorus", "Phosphorus", 0, 0, 317, 0, false, false, 2, 1, 1, Dyes.dyeYellow, Element.P, Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.IGNIS, 2), new TC_AspectStack(TC_Aspects.POTENTIA, 1)));
    ...
    public static Materials Phosphate = new Materials(833, TextureSet.SET_DULL, 		1.0F, 0, 1, 1 |8|16, 255, 255, 0, 0, "Phosphate", "Phosphate", 0, 0, -1, 0, false, false, 2, 1, 1, Dyes.dyeYellow, 1, Arrays.asList(new MaterialStack(Phosphorus_NEW, 1), new MaterialStack(Oxygen, 4)));
    ...
    public static Materials PhosphorousPentoxide = new MaterialBuilder(665, TextureSet.SET_FLUID, "Phosphorous Pentoxide").addCell().addDustItems().setRGB(220, 220, 0).setColor(Dyes.dyeYellow).setMaterialList(new MaterialStack(Phosphorus_NEW, 4), new MaterialStack(Oxygen, 10)).addElectrolyzerRecipe().constructMaterial();
    ...
    @Deprecated public static Materials Phosphor = new Materials(Phosphorus_NEW, true);
    @Deprecated public static Materials Phosphorus = new Materials(TricalciumPhosphate, true);
    ...
    static {
        ...
        Phosphate				.addOreByProducts(Phosphorus_NEW			);
        Phosphorus_NEW				.addOreByProducts(Phosphate				);
