...
public enum Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    DarkSteel           ( 364, TextureSet.SET_METALLIC          ,   8.0F,    512,  3, 1|2         |64|128                   ,  80,  70,  80,   0,    "Dark Steel"                   ,    0,       0,       1811, 1500,  true, false,   3,   1,   1, Dyes.dyePurple      ),
    Terrasteel          (  -1, TextureSet.SET_NONE              ,   1.0F,      0,  2, 1|2                                   , 255, 255, 255,   0,    "Terrasteel"                   ,    0,       0,         -1,    0, false, false,   3,   1,   1, Dyes._NULL          ),
    ConductiveIron      ( 369, TextureSet.SET_METALLIC          ,   6.0F,    256,  3, 1|2         |64|128                   , 217, 178, 171,   0,    "Conductive Iron"              ,    0,       0,       1811, 1200,  true, false,   4,   1,   1, Dyes.dyeRed         ),
    ...
    EnergeticAlloy      ( 366, TextureSet.SET_METALLIC          ,  12.0F,   1024,  3, 1|2         |64|128                   , 255, 170,  81,   0,    "Energetic Alloy"              ,    0,       0,       1800, 1500,  true, false,   3,   1,   1, Dyes.dyeOrange      ),
    ...
    PulsatingIron       ( 378, TextureSet.SET_METALLIC          ,   6.0F,    256,  3, 1|2         |64|128                   , 128, 246, 155,   0,    "Pulsating Iron"               ,    0,       0,       1811, 1600,  true, false,   4,   1,   1, Dyes.dyeLime        ),
