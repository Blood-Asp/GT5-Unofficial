...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials Ethanol = new Materials(706, TextureSet.SET_FLUID, 		1.0F, 0, 0, 16, 255, 128, 0, 0, "Ethanol", "Ethanol", 0, 148, -1, 0, false, false, 1, 9, 1, Dyes.dyeOrange, 1, Arrays.asList(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 6), new MaterialStack(Oxygen, 1)), Arrays.asList(new TC_AspectStack(TC_Aspects.VENENUM, 1), new TC_AspectStack(TC_Aspects.AQUA, 1))).setReverseRecipeEUByMaterialValue(true);
     ...
     */
    public static Materials Methane = new Materials(715, TextureSet.SET_FLUID, 			1.0F, 0, 1, 16, 255, 255, 255, 0, "Methane", "Methane", 1, 104, -1, 0, false, false, 3, 5, 1, Dyes.dyeMagenta, 1, Arrays.asList(new MaterialStack(Carbon, 1), new MaterialStack(Hydrogen, 4))).setReverseRecipeEUByMaterialValue(true);
    public static Materials CarbonDioxide = new Materials(497, TextureSet.SET_FLUID, 	1.0F, 0, 2, 16|32, 169, 208, 245, 240, "CarbonDioxide", "Carbon Dioxide", 0, 0, 25, 1, false, true, 1, 3, 1, Dyes.dyeLightBlue, 1, Arrays.asList(new MaterialStack(Carbon, 1), new MaterialStack(Oxygen, 2))).setHasCorrespondingGas(true).setReverseRecipeEUByMaterialValue(true);
    ...
    public static Materials Calcite = new Materials(823, TextureSet.SET_DULL, 			1.0F, 0, 1, 1 |8 , 250, 230, 220, 0, "Calcite", "Calcite", 0, 0, -1, 0, false, false, 1, 5, 1, Dyes.dyeOrange, 1, Arrays.asList(new MaterialStack(Calcium, 1), new MaterialStack(Carbon, 1), new MaterialStack(Oxygen, 3))).setReverseRecipeEUByMaterialValue(true);
    ...
    public static Materials Glyceryl = new Materials(714, TextureSet.SET_FLUID, 		1.0F, 0, 1, 16, 0, 150, 150, 0, "Glyceryl", "Glyceryl Trinitrate", 0, 0, -1, 0, false, false, 1, 20, 1, Dyes.dyeCyan, 1, Arrays.asList(new MaterialStack(Carbon, 3), new MaterialStack(Hydrogen, 5), new MaterialStack(Nitrogen, 3), new MaterialStack(Oxygen, 9))).setReverseRecipeEUByMaterialValue(true);
    ...
    public static Materials NitrogenDioxide = new Materials(717, TextureSet.SET_FLUID, 	1.0F, 0, 1, 16, 100, 175, 255, 0, "NitrogenDioxide", "Nitrogen Dioxide", 0, 0, -1, 0, false, false, 1, 3, 1, Dyes.dyeCyan, 1, Arrays.asList(new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 2))).setReverseRecipeEUByMaterialValue(true);
    ...
    public static Materials SodiumPersulfate = new Materials(718, TextureSet.SET_FLUID, 1.0F, 0, 2, 16, 255, 255, 255, 0, "SodiumPersulfate", "Sodium Persulfate", 0, 0, -1, 0, false, false, 1, 12, 1, Dyes.dyeOrange, 1, Arrays.asList(new MaterialStack(Sodium, 2), new MaterialStack(Sulfur, 2), new MaterialStack(Oxygen, 8))).setReverseRecipeEUByMaterialValue(true);
    public static Materials SodiumSulfide = new Materials(719, TextureSet.SET_FLUID, 	1.0F, 0, 2, 1, 255, 230, 128, 0, "SodiumSulfide", "Sodium Sulfide", 0, 0, -1, 0, false, false, 1, 3, 1, Dyes.dyeOrange, 1, Arrays.asList(new MaterialStack(Sodium, 2), new MaterialStack(Sulfur, 1))).setReverseRecipeEUByMaterialValue(true);
    ...
    public static Materials Chlorobenzene = new MaterialBuilder(605, TextureSet.SET_FLUID, "Chlorobenzene").addCell().addFluid().setRGB(0, 50, 65).setColor(Dyes.dyeGray).setMaterialList(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 5), new MaterialStack(Chlorine, 1)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    ...
    public static Materials Quicklime = new MaterialBuilder(622, TextureSet.SET_DULL, "Quicklime").addDustItems().setRGB(240, 240, 240).setColor(Dyes.dyeWhite).setMaterialList(new MaterialStack(Calcium, 1), new MaterialStack(Oxygen, 1)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    public static Materials Potash = new MaterialBuilder(623, TextureSet.SET_DULL, "Potash").addDustItems().setRGB(120, 66, 55).setColor(Dyes.dyeBrown).setMaterialList(new MaterialStack(Potassium, 2), new MaterialStack(Carbon, 1), new MaterialStack(Oxygen, 3)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    public static Materials SodaAsh = new MaterialBuilder(624, TextureSet.SET_DULL, "Soda Ash").addDustItems().setRGB(220, 220, 255).setColor(Dyes.dyeWhite).setMaterialList(new MaterialStack(Sodium, 2), new MaterialStack(Carbon, 1), new MaterialStack(Oxygen, 3)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    ...
    public static Materials Dichlorobenzene = new MaterialBuilder(632, TextureSet.SET_FLUID, "Dichlorobenzene").addCell().addFluid().setRGB(0, 68, 85).setColor(Dyes.dyeBlue).setMaterialList(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 4), new MaterialStack(Chlorine, 2)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    ...
    public static Materials Toluene = new MaterialBuilder(647, TextureSet.SET_FLUID, "Toluene").addCell().setRGB(80, 29, 5).setColor(Dyes.dyeBrown).setFuelType(MaterialBuilder.GAS).setFuelPower(328).setMaterialList(new MaterialStack(Carbon, 7), new MaterialStack(Hydrogen, 8)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    ...
    public static Materials SulfurDioxide = new MaterialBuilder(651, TextureSet.SET_FLUID, "Sulfur Dioxide").addCell().addGas().setRGB(200, 200, 25).setColor(Dyes.dyeYellow).setMaterialList(new MaterialStack(Sulfur, 1), new MaterialStack(Oxygen, 2)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    public static Materials SulfurTrioxide = new MaterialBuilder(652, TextureSet.SET_FLUID, "Sulfur Trioxide").addCell().addGas().setGasTemperature(344).setRGB(160, 160, 20).setColor(Dyes.dyeYellow).setMaterialList(new MaterialStack(Sulfur, 1), new MaterialStack(Oxygen, 3)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    public static Materials NitricAcid = new MaterialBuilder(653, TextureSet.SET_FLUID, "Nitric Acid").addCell().setRGB(230, 226, 171).setMaterialList(new MaterialStack(Hydrogen, 1), new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 3)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    public static Materials Dimethylhydrazine = new MaterialBuilder(654, TextureSet.SET_FLUID, "1,1-Dimethylhydrazine").addCell().addFluid().setRGB(0, 0, 85).setColor(Dyes.dyeBlue).setMaterialList(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 8), new MaterialStack(Nitrogen, 2)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    ...
    public static Materials Dimethylamine = new MaterialBuilder(656, TextureSet.SET_FLUID, "Dimethylamine").addCell().addGas().setRGB(85, 68, 105).setColor(Dyes.dyeGray).setMaterialList(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 7), new MaterialStack(Nitrogen, 1)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    public static Materials DinitrogenTetroxide = new MaterialBuilder(657, TextureSet.SET_FLUID, "Dinitrogen Tetroxide").addCell().addGas().setRGB(0, 65, 132).setColor(Dyes.dyeBlue).setMaterialList(new MaterialStack(Nitrogen, 2), new MaterialStack(Oxygen, 4)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    public static Materials NitricOxide = new MaterialBuilder(658, TextureSet.SET_FLUID, "Nitric Oxide").addCell().addGas().setRGB(125, 200, 240).setColor(Dyes.dyeCyan).setMaterialList(new MaterialStack(Nitrogen, 1), new MaterialStack(Oxygen, 1)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    public static Materials Ammonia = new MaterialBuilder(659, TextureSet.SET_FLUID, "Ammonia").addCell().addGas().setRGB(63, 52, 128).setColor(Dyes.dyeBlue).setMaterialList(new MaterialStack(Nitrogen, 1), new MaterialStack(Hydrogen, 3)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    public static Materials Dimethyldichlorosilane = new MaterialBuilder(663, TextureSet.SET_FLUID, "Dimethyldichlorosilane").addCell().addFluid().setRGB(68, 22, 80).setColor(Dyes.dyePurple).setMaterialList(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 6), new MaterialStack(Chlorine, 2), new MaterialStack(Silicon, 1)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    ...
    public static Materials PhosphorousPentoxide = new MaterialBuilder(665, TextureSet.SET_FLUID, "Phosphorous Pentoxide").addCell().addDustItems().setRGB(220, 220, 0).setColor(Dyes.dyeYellow).setMaterialList(new MaterialStack(Phosphor, 4), new MaterialStack(Oxygen, 10)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    public static Materials Tetrafluoroethylene = new MaterialBuilder(666, TextureSet.SET_FLUID, "Tetrafluoroethylene").addCell().addGas().setRGB(125, 125, 125).setColor(Dyes.dyeGray).setMaterialList(new MaterialStack(Carbon, 2), new MaterialStack(Fluorine, 4)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    public static Materials HydrofluoricAcid = new MaterialBuilder(667, TextureSet.SET_FLUID, "Hydrofluoric Acid").setName("HydrofluoricAcid_GT5U").addCell().addFluid().setRGB(0, 136, 170).setColor(Dyes.dyeLightBlue).setMaterialList(new MaterialStack(Hydrogen, 1), new MaterialStack(Fluorine, 1)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    public static Materials Chloroform = new MaterialBuilder(668, TextureSet.SET_FLUID, "Chloroform").addCell().addFluid().setRGB(137, 44, 160).setColor(Dyes.dyePurple).setMaterialList(new MaterialStack(Carbon, 1), new MaterialStack(Hydrogen, 1), new MaterialStack(Chlorine, 3)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    ...
    public static Materials MethylAcetate = new MaterialBuilder(681, TextureSet.SET_FLUID, "Methyl Acetate").addCell().addFluid().setRGB(238, 198, 175).setColor(Dyes.dyeOrange).setMaterialList(new MaterialStack(Carbon, 3), new MaterialStack(Hydrogen, 6), new MaterialStack(Oxygen, 2)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    ...
    public static Materials Cumene = new MaterialBuilder(688, TextureSet.SET_FLUID, "Cumene").addCell().addFluid().setRGB(85, 34, 0).setColor(Dyes.dyeBrown).setMaterialList(new MaterialStack(Carbon, 9), new MaterialStack(Hydrogen, 12)).setReverseRecipeEUByMaterialValue(true).setDensityToFormulaSize().addElectrolyzerRecipe().constructMaterial();
    ...
    public static Materials SulfuricAcid = new Materials(720, TextureSet.SET_FLUID, 	1.0F, 0, 2, 16, 255, 128, 0, 0, "SulfuricAcid", "Sulfuric Acid", 0, 0, -1, 0, false, false, 1, 7, 1, Dyes.dyeOrange, 1, Arrays.asList(new MaterialStack(Hydrogen, 2), new MaterialStack(Sulfur, 1), new MaterialStack(Oxygen, 4))).setReverseRecipeEUByMaterialValue(true);
	...
	public Materials setReverseRecipeEUByMaterialValue(boolean reverseRecipeEUByMaterialValue) {
    ...
    /**
     * Reverse recipes refer to Electrolysis/Centrifugation.
     * Normally the EU cost for reverse recipes is calculated from the atomic properties of the materials (number of protons/neutrons).
     * This method calculates the EU cost depending on the perceived value of the outputs and the burn value of the input and outputs.
     * This method is intended for materials that can be manufactured by the player.
     * Currently Hydrogen and Oxygen are given increased EU cost.
     * Hydrogen, because otherwise it would be too cheap to obtain from Hydrocarbons.
     * Oxygen, because Hydrocarbons with Oxygen have a lower burn value than those without Oxygen.
     * @param material The material to be electrolyzed/centrifuged
     * @return The amount of EU perceived proportional to the usefulness of the outputs
     */
    public int calculateReverseRecipeEUByMaterialValue(){
    	int EU = 0;
    	for (MaterialStack materialStack : this.mMaterialList) {
    		if (materialStack.mMaterial == Materials.Hydrogen) {
    			EU += 18000 * materialStack.mAmount;
    		} else if (materialStack.mMaterial == Materials.Oxygen) {
    			EU += 24000 * materialStack.mAmount;
    		} else {
    			EU += 12000 * materialStack.mAmount;    			
    		}
    	}
    	return EU;
    }
