...
public enum Materials implements IColorModulationContainer, ISubTagContainer {
	...
	Cobalt              (  33, TextureSet.SET_METALLIC          ,   8.0F,    512,  3, 1|2  |8   |32|64                      ,  80,  80, 250,   0,    "Cobalt"                       ,    0,       0,       1768,21700, true, false,    3,   1,   1, Dyes.dyeBlue        , Element.Co        , Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.INSTRUMENTUM, 1))),
	...
	Hydrogen			(   1, TextureSet.SET_FLUID				,   1.0F,      0,  2,         16|32                         ,   0,   0, 255, 240,	"Hydrogen"						,    1,      20,         14,    0, false, true,    2,   1,   1, Dyes.dyeBlue	    , Element.H			, Arrays.asList(new TC_AspectStack(TC_Aspects.AQUA, 1))),
	...
	Iridium				(  84, TextureSet.SET_DULL				,   6.0F,   2560,  3, 1|2  |8   |32|64|128                  , 240, 240, 245,   0,	"Iridium"						,    0,       0,       2719,22719, true, false,   10,   1,   1, Dyes.dyeWhite		, Element.Ir		, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.MACHINA, 1))),
	...
	Neutronium			( 129, TextureSet.SET_DULL				,  24.0F, 655360,  6, 1|2  |8   |32|64|128                  , 250, 250, 250,   0,	"Neutronium"					,    0,       0,      10000,29000,  true, false,  20,   1,   1, Dyes.dyeWhite		, Element.Nt		, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 4), new TC_AspectStack(TC_Aspects.VITREUS, 3), new TC_AspectStack(TC_Aspects.ALIENIS, 2))),
	...
	Osmium				(  83, TextureSet.SET_METALLIC			,  16.0F,   1280,  4, 1|2  |8   |32|64|128                  ,  50,  50, 255,   0,	"Osmium"						,    0,       0,       3306,23306, true, false,   10,   1,   1, Dyes.dyeBlue	    , Element.Os		, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.MACHINA, 1), new TC_AspectStack(TC_Aspects.NEBRISUM, 1))),
	...
	Samarium			(  69, TextureSet.SET_MAGNETIC			,   1.0F,      0,  2, 1|2  |8   |32                         , 255, 255, 255,   0,	"Samarium"						,    0,       0,       1345, 1345, true, false,    4,   1,   1, Dyes._NULL			, Element.Sm		, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.RADIO, 1), new TC_AspectStack(TC_Aspects.MAGNETO,10))),
	...
	RedstoneAlloy       ( 381, TextureSet.SET_METALLIC          ,   3.0F,    128,  2, 1|2         |64|128                   , 181,  51,  51,   0,   "Redstone Alloy"                ,    0,       0,        500,21000,  true, false,   1,   1,   1, Dyes.dyeRed         , 1, Arrays.asList(new MaterialStack(Redstone, 1), new MaterialStack(Silicon, 1), new MaterialStack(Coal, 1))),
	...
	HeeEndium           ( 770, TextureSet.SET_DULL              ,  16.0F,   1024,  4, 1|2  |8     |64|128                   , 165, 220, 250,   0,   "Endium"                        ,    0,       0,         -1,    0, false, false,   3,   1,   1, Dyes.dyeLightBlue   ),
    ...
    ConductiveIron      ( 369, TextureSet.SET_METALLIC          ,   6.0F,    256,  3, 1|2         |64|128                   , 217, 178, 171,   0,   "Conductive Iron"               ,    0,       0,         -1,21200,  true, false,   4,   1,   1, Dyes.dyeRed         , 1, Arrays.asList(new MaterialStack(RedstoneAlloy, 1), new MaterialStack(Iron, 1), new MaterialStack(Silver, 1))),
	...
	ElectricalSteel     ( 365, TextureSet.SET_METALLIC          ,   6.0F,    512,  2, 1|2         |64|128                   , 185, 185, 185,   0,   "Electrical Steel"              ,    0,       0,       1811,21000,  true, false,   4,   1,   1, Dyes.dyeGray        , 1, Arrays.asList(new MaterialStack(Steel, 1), new MaterialStack(Coal, 1), new MaterialStack(Silicon, 1))),
	TungstenSteel		( 316, TextureSet.SET_METALLIC			,   8.0F,   2560,  4, 1|2          |64|128                  , 100, 100, 160,   0,	"Tungstensteel"					,    0,       0,         -1,23000,  true, false,   4,   1,   1, Dyes.dyeBlue		, 2, Arrays.asList(new MaterialStack(Steel, 1), new MaterialStack(Tungsten, 1))),
    ...
    PulsatingIron       ( 378, TextureSet.SET_METALLIC          ,   6.0F,    256,  3, 1|2         |64|128                   , 128, 246, 155,   0,   "Pulsating Iron"                ,    0,       0,         -1,21800,  true, false,   4,   1,   1, Dyes.dyeLime        , 1, Arrays.asList(new MaterialStack(Iron, 1), new MaterialStack(EnderPearl, 1), new MaterialStack(RedstoneAlloy, 1))),
	...
	Draconium           ( 975, TextureSet.SET_SHINY             ,  20.0F,  32768,  7, 1|2|  8|   32|64|128                  , 122,  68, 176,   0,   "Draconium"                     ,    0,       0,       5000,25000,  true, false,   3,   1,   1, Dyes.dyePink        ),
	DraconiumAwakened   ( 976, TextureSet.SET_SHINY             ,  40.0F,  65536,  8, 1|2|  8|   32|64|128                  , 244,  78,   0,   0,   "Awakened Draconium"            ,    0,       0,       9000,29000,  true, false,   3,   1,   1, Dyes.dyeOrange      ),
	 ...
	 */
	Rubracium			( 488, TextureSet.SET_METALLIC			,   1.0F,    128,  1, 1|2  |8      |64|128                  , 151,  45,  45,   0,	"Rubracium"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyeRed			),
	Mithril				( 331, TextureSet.SET_SHINY				,  14.0F,     64,  3, 1|2  |8      |64                      , 255, 255, 210,   0,	"Mithril"						,    0,       0,         -1,    0, false, false,   4,   3,   2, Dyes.dyeLightBlue	, 2, Arrays.asList(new MaterialStack(Platinum, 2), new MaterialStack(Thaumium, 1))),
	Orichalcum			( 966, TextureSet.SET_METALLIC			,   4.5F,   3456,  3, 1|2  |8      |64|128                  ,  84, 122,  56,   0,	"Orichalcum"					,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	...
	Adluorite			(  -1, TextureSet.SET_NONE				,   1.0F,      0,  2, 1|2  |8      |64|128                  , 255, 255, 255,   0,	"Adluorite"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyeLightBlue	),
	Agate				(  -1, TextureSet.SET_NONE				,   1.0F,      0,  2, 1                                     , 255, 255, 255,   0,	"Agate"							,    0,       0,         -1,    0, false, false,   3,   1,   1, Dyes._NULL			),
	Alduorite			( 485, TextureSet.SET_SHINY  			,   3.0F,    384,  2, 1|2  |8      |64|128                  , 159, 180, 180,   0,	"Alduorite"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	...
	Amordrine			(  -1, TextureSet.SET_NONE				,   6.0F,     64,  2, 1|2  |8      |64                   	, 255, 255, 255,   0,	"Amordrine"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	Andesite			(  -1, TextureSet.SET_NONE				,   1.0F,      0,  2, 1    |8                               , 255, 255, 255,   0,	"Andesite"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	Angmallen			( 958, TextureSet.SET_METALLIC			,  10.0F,    128,  2, 1|2  |8      |64                      , 215, 225, 138,   0,	"Angmallen"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
    Ardite              ( 382, TextureSet.SET_METALLIC         ,   18.0F,   1024,  4, 1|2  |8   |32|64|128                  , 250, 129,   0,   0,   "Ardite"                        ,    0,       0,       1600,21600,  true, false,   1,   1,   1, Dyes.dyeRed         ),
	...
	Celenegil			( 964, TextureSet.SET_METALLIC			,  10.0F,   4096,  2, 1|2  |8      |64                   	, 148, 204,  72,   0,	"Celenegil"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	...
	Ceruclase			( 952, TextureSet.SET_METALLIC			,   6.0F,   1280,  2, 1|2  |8      |64|128                  , 140, 189, 208,   0,	"Ceruclase"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyeBlue		),
	...
	Desh                ( 884, TextureSet.SET_DULL              , 20.0F,   1280,   4, 1|2  |8         |64|128               ,  40,  40,  40,   0,   "Desh"                          ,    0,       0,       2500,22500,  true, false,   1,   1,   1, Dyes.dyeBlack       ),
	Desichalkos			(  -1, TextureSet.SET_NONE				,   6.0F,   1280,  3, 1|2  |8         |64                   , 255, 255, 255,   0,	"Desichalkos"					,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	...
	Duranium			( 328, TextureSet.SET_METALLIC			,  16.0F,   5120,  5, 1|2          |64                      , 255, 255, 255,   0,	"Duranium"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyeLightGray	),
	Eclogite			( 860, TextureSet.SET_DULL				,   1.0F,      0,  2, 1                                     , 255, 255, 255,   0,	"Eclogite"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	ElectrumFlux		( 320, TextureSet.SET_SHINY				,  16.0F,    512,  3, 1|2          |64                      , 255, 255, 120,   0,	"Fluxed Electrum"				,    0,       0,       9000,29000,  true, false,   1,   1,   1, Dyes.dyeYellow		),
	Emery				( 861, TextureSet.SET_DULL				,   1.0F,      0,  2, 1    |8                               , 255, 255, 255,   0,	"Emery"							,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	EnderiumBase        ( 380, TextureSet.SET_DULL              ,  16.0F,   768,  4, 1|2          |64|128                   ,  72, 119, 153,   0,   "Enderium Base"                 ,    0,       0,       3600,23600,  true, false,   1,   1,   1, Dyes.dyeGreen        , 1, Arrays.asList(new MaterialStack(Tin, 2), new MaterialStack(Silver, 1), new MaterialStack(Platinum, 1)), Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.ALIENIS, 1))),
	Enderium            ( 321, TextureSet.SET_DULL              ,   8.0F,  1500,  3, 1|2          |64|128                   ,  89, 145, 135,   0,   "Enderium"                      ,    0,       0,       4500,24500,  true, false,   1,   1,   1, Dyes.dyeGreen        , 1, Arrays.asList(new MaterialStack(EnderiumBase, 2), new MaterialStack(Thaumium, 1), new MaterialStack(EnderPearl, 1)), Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.ALIENIS, 1))),
	...
	Eximite				( 959, TextureSet.SET_METALLIC			,   5.0F,   2560,  3, 1|2  |8      |64                      , 124,  90, 150,   0,	"Eximite"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
 	FierySteel			( 346, TextureSet.SET_FIERY				,   8.0F,    256,  3, 1|2          |64|128                  ,  64,   0,   0,   0,	"Fiery Steel"					,    5,    2048,       1811,21800,  true, false,   1,   1,   1, Dyes.dyeRed			, Arrays.asList(new TC_AspectStack(TC_Aspects.PRAECANTATIO, 3), new TC_AspectStack(TC_Aspects.IGNIS, 3), new TC_AspectStack(TC_Aspects.CORPUS, 3))),
	...
	Haderoth			( 963, TextureSet.SET_METALLIC			,  10.0F,   3200,  3, 1|2  |8         |64                   , 119,  52,  30,   0,	"Haderoth"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
 	Hematite			(  -1, TextureSet.SET_NONE				,   1.0F,      0,  2, 1|2  |8                               , 255, 255, 255,   0,	"Hematite"						,    0,       0,         -1,    0, false, false,   3,   1,   1, Dyes._NULL			),
 	Hepatizon			( 957, TextureSet.SET_METALLIC			,  12.0F,    128,  2, 1|2  |8         |64                   , 117,  94, 117,   0,	"Hepatizon"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
 	HSLA				( 322, TextureSet.SET_METALLIC			,   6.0F,    500,  3, 1|2          |64|128                  , 128, 128, 128,   0,	"HSLA Steel"					,    0,       0,       1811, 1000,  true, false,   3,   1,   1, Dyes._NULL			, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 1), new TC_AspectStack(TC_Aspects.ORDO, 1))),
 	Ignatius			( 950, TextureSet.SET_METALLIC			,  12.0F,    512,  2, 1|2                                   , 255, 169,  83,   0,	"Ignatius"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
 	Infernal			(  -1, TextureSet.SET_NONE				,   1.0F,      0,  2, 0                                     , 255, 255, 255,   0,	"Infernal"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
 	Infuscolium			( 490, TextureSet.SET_METALLIC			,   6.0F,     64,  2, 1|2  |8      |64                      , 146,  33,  86,   0,	"Infuscolium"					,    0,       0,         -1,    0, false, false,   3,   1,   1, Dyes._NULL			),
	...
	Inolashite			( 954, TextureSet.SET_NONE				,   8.0F,   2304,  3, 1|2  |8      |64                      , 148, 216, 187,   0,	"Inolashite"					,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyeGreen		),
 	Invisium			(  -1, TextureSet.SET_NONE				,   1.0F,      0,  2, 1                                     , 255, 255, 255,   0,	"Invisium"						,    0,       0,         -1,    0, false, false,   3,   1,   1, Dyes._NULL			),
	Jade				( 537, TextureSet.SET_SHINY				,   1.0F,      0,  2, 1  |4|8      |64                      ,   0, 100,   0,   0,	"Jade"							,    0,       0,         -1,    0, false, false,   5,   1,   1, Dyes.dyeGreen		, Arrays.asList(new TC_AspectStack(TC_Aspects.LUCRUM, 6), new TC_AspectStack(TC_Aspects.VITREUS, 3))),
	Jasper				( 511, TextureSet.SET_EMERALD			,   1.0F,      0,  2, 1  |4|8      |64                      , 200,  80,  80, 100,	"Jasper"						,    0,       0,         -1,    0, false,  true,   3,   1,   1, Dyes.dyeRed			, Arrays.asList(new TC_AspectStack(TC_Aspects.LUCRUM, 4), new TC_AspectStack(TC_Aspects.VITREUS, 2))),
	Kalendrite			( 953, TextureSet.SET_METALLIC			,   5.0F,   2560,  3, 1|2                                   , 170,  91, 189,   0,	"Kalendrite"					,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	...
	Lemurite			( 486, TextureSet.SET_METALLIC			,   1.0F,      0,  2, 1                                     , 219, 219, 219,   0,	"Lemurite"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	...
	MeteoricIron		( 340, TextureSet.SET_METALLIC			,   6.0F,    384,  3, 1|2  |8      |64                      , 100,  50,  80,   0,	"Meteoric Iron"					,    0,       0,       1811, 1000,  true, false,   1,   1,   1, Dyes.dyeGray			, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.MAGNETO, 1))),
	MeteoricSteel		( 341, TextureSet.SET_METALLIC			,   6.0F,    768,  4, 1|2          |64                      ,  50,  25,  40,   0,	"Meteoric Steel"				,    0,       0,       1811, 1000,  true, false,   1,   1,   1, Dyes.dyeGray			, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.MAGNETO, 1), new TC_AspectStack(TC_Aspects.ORDO, 1))),
	Meteorite			(  -1, TextureSet.SET_NONE				,   1.0F,      0,  1, 1    |8                               ,  80,  35,  60,   0,	"Meteorite"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyePurple		),
	Meutoite			( 487, TextureSet.SET_METALLIC			,   1.0F,      0,  1, 1    |8                               ,  95,  82, 105,   0,	"Meutoite"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	...
	Naquadah			( 324, TextureSet.SET_METALLIC			,   6.0F,   1280,  4, 1|2  |8      |64                      ,  50,  50,  50,   0,	"Naquadah"						,    0,       0,       5400,25400,  true, false,  10,   1,   1, Dyes.dyeBlack		, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 3), new TC_AspectStack(TC_Aspects.RADIO, 1), new TC_AspectStack(TC_Aspects.NEBRISUM, 1))),
	NaquadahAlloy		( 325, TextureSet.SET_METALLIC			,   8.0F,   5120,  5, 1|2          |64|128                  ,  40,  40,  40,   0,	"Naquadah Alloy"				,    0,       0,       7200,27200,  true, false,  10,   1,   1, Dyes.dyeBlack		, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 4), new TC_AspectStack(TC_Aspects.NEBRISUM, 1))),
	NaquadahEnriched	( 326, TextureSet.SET_METALLIC			,   6.0F,   1280,  4, 1|2  |8      |64                      ,  50,  50,  50,   0,	"Enriched Naquadah"				,    0,       0,       4500,24500,  true, false,  15,   1,   1, Dyes.dyeBlack		, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 3), new TC_AspectStack(TC_Aspects.RADIO, 2), new TC_AspectStack(TC_Aspects.NEBRISUM, 2))),
	Naquadria			( 327, TextureSet.SET_SHINY				,   1.0F,    512,  4, 1|2  |8      |64                      ,  30,  30,  30,   0,	"Naquadria"						,    0,       0,       9000,29000,  true, false,  20,   1,   1, Dyes.dyeBlack		, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 4), new TC_AspectStack(TC_Aspects.RADIO, 3), new TC_AspectStack(TC_Aspects.NEBRISUM, 3))),
	...
	NetherStar			( 506, TextureSet.SET_NETHERSTAR		,   6.0F,   5120,  4, 1|  4|8      |64|128                  , 255, 255, 255,   0,	"Nether Star"					,    5,   50000,         -1,    0, false, false,  15,   1,   1, Dyes.dyeWhite		),
...
// 	RyuDragonRyder		(  -1, TextureSet.SET_NONE				,   1.0F,      0,  1, 0                                     , 255, 255, 255,   0,	"Ryu Dragon Ryder"				,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	...
	Tartarite			( 956, TextureSet.SET_METALLIC			,  20.0F,   7680,  5, 1|2  |8                               , 255, 118,  60,   0,	"Tartarite"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	...
	Tritanium			( 329, TextureSet.SET_METALLIC			,  20.0F,  10240,  6, 1|2          |64                      , 255, 255, 255,   0,	"Tritanium"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyeWhite		, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_AspectStack(TC_Aspects.ORDO, 2))),
	...
	Void	            ( 970, TextureSet.SET_METALLIC          ,  16.0F,    512,  4, 1|2          |64|128                  ,  28,   6,  57,   0,   "Void"                          ,    5,    1500,         -1,    0, false,  true,   5,   2,   1, Dyes.dyeBlack       , Arrays.asList(new TC_AspectStack(TC_Aspects.VACUOS, 1))),
	Vulcanite			( 489, TextureSet.SET_METALLIC			,   6.0F,     64,  2, 1|2  |8      |64|128                  , 255, 132,  72,   0,	"Vulcanite"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	...
	Fuel				( 708, TextureSet.SET_FLUID				,   1.0F,      0,  0,         16                            , 255, 255,   0,   0,	"Diesel"						,    0,     400,         -1,    0, false, false,   1,   1,   1, Dyes.dyeYellow		),
	...
	Oil					( 707, TextureSet.SET_FLUID				,   1.0F,      0,  0,         16                            ,  10,  10,  10,   0,	"Oil"							,    3,      20,         -1,    0, false, false,   1,   1,   1, Dyes.dyeBlack		),
    ...
    Reinforced          ( 383, TextureSet.SET_METALLIC          ,   7.0F,    480,  4, 1|2          |64|128                  , 105, 141, 165,   0,   "Reinforced"                    ,    0,       0,         -1,21700,  true, false,   1,   1,   1, Dyes.dyeBlue        ),
    ...
    Osmiridium          ( 317, TextureSet.SET_METALLIC          ,   7.0F,   1600,  3, 1|2          |64|128                  , 100, 100, 255,   0,    "Osmiridium"                   ,    0,       0,       3500,23500,  true, false,   1,   1,   1, Dyes.dyeLightBlue   , 1, Arrays.asList(new MaterialStack(Iridium, 3), new MaterialStack(Osmium, 1))),
    Sunnarium           ( 318, TextureSet.SET_SHINY             ,   1.0F,      0,  1, 1|2          |64|128                  , 255, 255,   0,   0,    "Sunnarium"                    ,    0,       0,       4200,24200,  true, false,   1,   1,   1, Dyes.dyeYellow      ),
	...
	Soularium           ( 379, TextureSet.SET_METALLIC          ,   8.0F,    256,  2, 1|2         |64|128                   ,  65,  46,  29,   0,   "Soularium"                     ,    0,       0,        800,21000,  true, false,   3,   1,   1, Dyes.dyeBrown      , 1, Arrays.asList(new MaterialStack(SoulSand, 1), new MaterialStack(Gold, 1), new MaterialStack(Ash, 1))),
	/**
	 * First Degree Compounds
	 */
	Methane				( 715, TextureSet.SET_FLUID				,   1.0F,      0,  1,         16                            , 255, 255, 255,   0,	"Methane"						,    1,      60,         -1,    0, false, false,   3,   1,   1, Dyes.dyeMagenta		, 1, Arrays.asList(new MaterialStack(Carbon, 1), new MaterialStack(Hydrogen, 4))),
	...
	Clay				( 805, TextureSet.SET_ROUGH				,   1.0F,      0,  1, 1                                     , 200, 200, 220,   0,	"Clay"							,    0,       0,         -1,    0, false, false,   5,   1,   1, Dyes.dyeLightBlue	, 1, Arrays.asList(new MaterialStack(Sodium, 2), new MaterialStack(Lithium, 1), new MaterialStack(Aluminium, 2), new MaterialStack(Silicon, 2),new MaterialStack(Water,6))),
	...
	Nikolite			( 812, TextureSet.SET_SHINY				,   1.0F,      0,  1, 1    |8                               ,  60, 180, 200,   0,	"Nikolite"						,    0,       0,         -1,    0, false, false,   3,   1,   1, Dyes.dyeCyan		, 8, Arrays.asList(new MaterialStack(Redstone, 1), new MaterialStack(Electrum, 1)), Arrays.asList(new TC_AspectStack(TC_Aspects.ELECTRUM, 2))),
    ...
    Galgadorian         ( 384, TextureSet.SET_METALLIC          ,  16.0F,   3600,  3, 1|2|          64|128                  , 154, 105, 119,   0,   "Galgadorian"                   ,    0,       0,       3000,23000,  true, false,   1,   1,   1, Dyes.dyePink        ),
	...
	Nichrome			( 311, TextureSet.SET_METALLIC			,   6.0F,     64,  2, 1|2          |64                      , 205, 206, 246,   0,	"Nichrome"						,    0,       0,       2700,22700,  true, false,   1,   1,   1, Dyes.dyeRed			, 2, Arrays.asList(new MaterialStack(Nickel, 4), new MaterialStack(Chrome, 1))),
	...
	NiobiumTitanium		( 360, TextureSet.SET_DULL				,   1.0F,      0,  2, 1|2                                   ,  29,  29,  41,   0,	"Niobium-Titanium"				,    0,       0,       4500,24500,  true, false,   1,   1,   1, Dyes.dyeBlack		, 2, Arrays.asList(new MaterialStack(Niobium, 1), new MaterialStack(Titanium, 1))),
	...
	DarkSteel           ( 364, TextureSet.SET_METALLIC          ,   8.0F,    512,  3, 1|2          |64|128                  ,  80,  70,  80,   0,   "Dark Steel"                    ,    0,       0,         -1,21800,  true, false,   3,   1,   1, Dyes.dyePurple      , 1, Arrays.asList(new MaterialStack(ElectricalSteel, 1), new MaterialStack(Coal, 1), new MaterialStack(Obsidian, 1))),
	...
	OilHeavy			( 730, TextureSet.SET_FLUID				,   1.0F,      0,  0,         16                            ,  10,  10,  10,   0,	"Heavy Oil"						,    3,      40,         -1,    0, false, false,   1,   1,   1, Dyes.dyeBlack		),
	OilMedium			( 731, TextureSet.SET_FLUID				,   1.0F,      0,  0,         16                            ,  10,  10,  10,   0,	"Raw Oil"						,    3,      30,         -1,    0, false, false,   1,   1,   1, Dyes.dyeBlack		),
	OilLight			( 732, TextureSet.SET_FLUID				,   1.0F,      0,  0,         16                            ,  10,  10,  10,   0,	"Light Oil"						,    3,      20,         -1,    0, false, false,   1,   1,   1, Dyes.dyeBlack		),

	NatruralGas			( 733, TextureSet.SET_FLUID				,   1.0F,      0,  1,         16                            , 255, 255, 255,   0,	"Natural Gas"					,    1,      20,         -1,    0, false, false,   3,   1,   1, Dyes.dyeWhite		),
	SulfuricGas			( 734, TextureSet.SET_FLUID				,   1.0F,      0,  1,         16                            , 255, 255, 255,   0,	"Sulfuric Gas"					,    1,      25,         -1,    0, false, false,   3,   1,   1, Dyes.dyeWhite		),
	Gas					( 735, TextureSet.SET_FLUID				,   1.0F,      0,  1,         16                            , 255, 255, 255,   0,	"Refinery Gas"					,    1,     160,         -1,    0, false, false,   3,   1,   1, Dyes.dyeWhite		),
	SulfuricNaphtha		( 736, TextureSet.SET_FLUID				,   1.0F,      0,  0,         16                            , 255, 255,   0,   0,	"Sulfuric Naphtha"				,    1,      40,         -1,    0, false, false,   1,   1,   1, Dyes.dyeYellow		),
	SulfuricLightFuel	( 737, TextureSet.SET_FLUID				,   1.0F,      0,  0,         16                            , 255, 255,   0,   0,	"Sulfuric Light Fuel"			,    0,      40,         -1,    0, false, false,   1,   1,   1, Dyes.dyeYellow		),
	SulfuricHeavyFuel	( 738, TextureSet.SET_FLUID				,   1.0F,      0,  0,         16                            , 255, 255,   0,   0,	"Sulfuric Heavy Fuel"			,    3,      40,         -1,    0, false, false,   1,   1,   1, Dyes.dyeBlack		),
	Naphtha				( 739, TextureSet.SET_FLUID				,   1.0F,      0,  0,         16                            , 255, 255,   0,   0,	"Naphtha"						,    1,     320,         -1,    0, false, false,   1,   1,   1, Dyes.dyeYellow		),
	LightFuel			( 740, TextureSet.SET_FLUID				,   1.0F,      0,  0,         16                            , 255, 255,   0,   0,	"Light Fuel"					,    0,     320,         -1,    0, false, false,   1,   1,   1, Dyes.dyeYellow		),
	HeavyFuel			( 741, TextureSet.SET_FLUID				,   1.0F,      0,  0,         16                            , 255, 255,   0,   0,	"Heavy Fuel"					,    3,     240,         -1,    0, false, false,   1,   1,   1, Dyes.dyeBlack		),
	LPG					( 742, TextureSet.SET_FLUID				,   1.0F,      0,  0,         16                            , 255, 255,   0,   0,	"LPG"							,    1,     320,         -1,    0, false, false,   1,   1,   1, Dyes.dyeYellow		),
	...
	StainlessSteel		( 306, TextureSet.SET_SHINY				,   7.0F,    480,  4, 1|2          |64|128                  , 200, 200, 220,   0,	"Stainless Steel"				,    0,       0,         -1, 1700,  true, false,   1,   1,   1, Dyes.dyeWhite		, 1, Arrays.asList(new MaterialStack(Iron, 6), new MaterialStack(Chrome, 1), new MaterialStack(Manganese, 1), new MaterialStack(Nickel, 1))),
	...
	VanadiumGallium		( 357, TextureSet.SET_SHINY				,   1.0F,      0,  2, 1|2                                   , 128, 128, 140,   0,	"Vanadium-Gallium"				,    0,       0,       4500,24500,  true, false,   1,   1,   1, Dyes.dyeGray		, 2, Arrays.asList(new MaterialStack(Vanadium, 3), new MaterialStack(Gallium, 1))),
	...
	Manyullyn			( 386, TextureSet.SET_SHINY		    	,  25.0F,   2048,  5, 1|2  |8      |64|128                  , 154,  76, 185,   0,	"Manyullyn"						,    0,       0,       3600,23600,  true, false,   1,   1,   1, Dyes.dyePurple		, 2, Arrays.asList(new MaterialStack(Cobalt, 1), new MaterialStack(Ardite, 1)), Arrays.asList(new TC_AspectStack(TC_Aspects.STRONTIO, 2))),
	Shadow				( 368, TextureSet.SET_METALLIC			,  32.0F,   8192,  4, 1|2  |8      |64|128                  ,  16,   3,  66,   0,	"Shadow"				    	,    0,       0,       1800, 1800,  true, false,   3,   4,   3, Dyes.dyeBlue		),
	ShadowIron			( 336, TextureSet.SET_METALLIC			,   6.0F,    384,  3, 1|2  |8      |64                      , 120, 120, 120,   0,	"Shadowiron"					,    0,       0,         -1,    0, false, false,   3,   4,   3, Dyes.dyeBlack		, 3, Arrays.asList(new MaterialStack(Iron, 1), new MaterialStack(Thaumium, 3))),
	ShadowSteel			( 337, TextureSet.SET_METALLIC			,   6.0F,    768,  4, 1|2          |64                      ,  90,  90,  90,   0,	"Shadowsteel"					,    0,       0,         -1, 1700,  true, false,   4,   4,   3, Dyes.dyeBlack		, 3, Arrays.asList(new MaterialStack(Steel, 1), new MaterialStack(Thaumium, 3))),
	...
	BlackSteel			( 334, TextureSet.SET_METALLIC			,   6.5F,    768,  3, 1|2          |64                      , 100, 100, 100,   0,	"Black Steel"					,    0,       0,         -1, 1200,  true, false,   4,   1,   1, Dyes.dyeBlack		, 2, Arrays.asList(new MaterialStack(Nickel, 1), new MaterialStack(BlackBronze, 1), new MaterialStack(Steel, 3))),
	RedSteel			( 348, TextureSet.SET_METALLIC			,   7.0F,    896,  4, 1|2          |64                      , 140, 100, 100,   0,	"Red Steel"						,    0,       0,         -1, 1300,  true, false,   4,   1,   1, Dyes.dyeRed  		, 2, Arrays.asList(new MaterialStack(SterlingSilver, 1), new MaterialStack(BismuthBronze, 1), new MaterialStack(Steel, 2), new MaterialStack(BlackSteel, 4))),
	BlueSteel			( 349, TextureSet.SET_METALLIC			,   7.5F,   1024,  4, 1|2          |64                      , 100, 100, 140,   0,	"Blue Steel"					,    0,       0,         -1, 1400,  true, false,   4,   1,   1, Dyes.dyeBlue		, 2, Arrays.asList(new MaterialStack(RoseGold, 1), new MaterialStack(Brass, 1), new MaterialStack(Steel, 2), new MaterialStack(BlackSteel, 4))),
	DamascusSteel		( 335, TextureSet.SET_METALLIC			,   8.0F,   1280,  3, 1|2          |64                      , 110, 110, 110,   0,	"Damascus Steel"				,    0,       0,       2000, 1500,  true, false,   4,   1,   1, Dyes.dyeGray		, 2, Arrays.asList(new MaterialStack(Steel, 1))),
	EnergeticAlloy      ( 366, TextureSet.SET_METALLIC          ,  12.0F,   1024,  3, 1|2         |64|128                   , 255, 170,  81,   0,   "Energetic Alloy"               ,    0,       0,         -1,22200,  true, false,   3,   1,   1, Dyes.dyeOrange      , 1, Arrays.asList(new MaterialStack(ConductiveIron, 1), new MaterialStack(Gold, 1), new MaterialStack(BlackSteel, 1))),
	VibrantAlloy        ( 367, TextureSet.SET_METALLIC          ,  18.0F,   4048,  4, 1|2         |64|128                   , 157, 188,  53,   0,   "Vibrant Alloy"                 ,    0,       0,       3300,23300,  true, false,   4,   1,   1, Dyes.dyeLime        , 1, Arrays.asList(new MaterialStack(EnergeticAlloy, 1), new MaterialStack(EnderEye, 1), new MaterialStack(Chrome, 1))),
	...
	Vinteum				( 529, TextureSet.SET_METALLIC			,  10.0F,    128,  3, 1|2  |8      |64|128                  , 100, 200, 255,   0,	"Vinteum"						,    5,      32,         -1,    0, false, false,   4,   1,   1, Dyes.dyeLightBlue	, 2, Arrays.asList(new MaterialStack(Thaumium, 1)), Arrays.asList(new TC_AspectStack(TC_Aspects.VITREUS, 2), new TC_AspectStack(TC_Aspects.PRAECANTATIO, 1))),
	...
	Chrysotile			( 912, TextureSet.SET_DULL				,   1.0F,      0,  2, 1|2  |8      |64|128                  , 110, 140, 110,   0,	"Chrysotile"					,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyeWhite		, 2, Arrays.asList(new MaterialStack(Asbestos, 1))),
	Realgar				( 913, TextureSet.SET_DULL				,   1.0F,     32,  1, 1|2  |8      |64|128                  , 140, 100, 100,   0,	"Realgar"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyeWhite		, 2, Arrays.asList(new MaterialStack(Arsenic, 4), new MaterialStack(Sulfur,4))),
	...
	Duralumin	    	( 392, TextureSet.SET_SHINY				,  16.0F,    512,  3, 1|2  |8      |64|128                  , 235, 209, 160,   0,   "Duralumin"     		        ,     0,       0,     1600,  1600,  true, false,  4,   1,   1, Dyes.dyeOrange		, 2, Arrays.asList(new MaterialStack(Aluminium, 6), new MaterialStack(Copper, 1), new MaterialStack(Manganese, 1), new MaterialStack(Magnesium, 1))),
    ...
    /**Extra data contains bits 0x01 - add reverse processing electrolyzer , 0x02 - add reverse processing centrifuge
     ...
     * @param aBlastFurnaceTemp     Used to determine the needed Heat capactiy Costs in Blast Furnii. ADD 20000 to remove EBF recipes to add them MANUALLY ! :D
