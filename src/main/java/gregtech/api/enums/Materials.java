...
public enum Materials implements IColorModulationContainer, ISubTagContainer {
	...
	Draconium           ( 975, TextureSet.SET_SHINY             ,  20.0F,  32768,  7, 1|2|  8|16|32|64|128                  , 122,  68, 176,   0,   "Draconium"                     ,    0,       0,       5000,25000,  true, false,   3,   1,   1, Dyes.dyePink        ),
	DraconiumAwakened   ( 976, TextureSet.SET_SHINY             ,  40.0F,  65536,  8, 1|2|  8|16|32|64|128                  , 244,  78,   0,   0,   "Awakened Draconium"            ,    0,       0,       9000,29000,  true, false,   3,   1,   1, Dyes.dyeOrange      ),
	 ...
	 */
	Rubracium			( 488, TextureSet.SET_METALLIC			,   1.0F,    128,  1, 1|2  |8|16   |64|128                  , 151,  45,  45,   0,	"Rubracium"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyeRed			),
	...
	Orichalcum			( 966, TextureSet.SET_METALLIC			,   4.5F,   3456,  3, 1|2  |8|16   |64|128                  ,  84, 122,  56,   0,	"Orichalcum"					,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	Adamantium			( 319, TextureSet.SET_SHINY				,  15.0F,   8192,  5, 1|2  |8|16   |64|128                  , 255, 255, 255,   0,	"Adamantium"					,    0,       0,       7200, 7200,  true, false,   1,   1,   1, Dyes.dyeLightGray	),
	Adamite				(  -1, TextureSet.SET_NONE				,   1.0F,      0,  3, 1    |8                               , 255, 255, 255,   0,	"Adamite"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyeLightGray	),
	Adluorite			(  -1, TextureSet.SET_NONE				,   1.0F,      0,  2, 1|2  |8|16   |64|128                  , 255, 255, 255,   0,	"Adluorite"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyeLightBlue	),
	Agate				(  -1, TextureSet.SET_NONE				,   1.0F,      0,  2, 1                                     , 255, 255, 255,   0,	"Agate"							,    0,       0,         -1,    0, false, false,   3,   1,   1, Dyes._NULL			),
	Alduorite			( 485, TextureSet.SET_SHINY  			,   3.0F,    384,  2, 1|2  |8|16   |64|128                  , 159, 180, 180,   0,	"Alduorite"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	...
	Ceruclase			( 952, TextureSet.SET_METALLIC			,   6.0F,   1280,  2, 1|2  |8|16   |64|128                  , 140, 189, 208,   0,	"Ceruclase"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyeBlue		),
	...
	Eximite				( 959, TextureSet.SET_METALLIC			,   5.0F,   2560,  3, 1|2  |8      |64                      , 124,  90, 150,   0,	"Eximite"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
 	FierySteel			( 346, TextureSet.SET_FIERY				,   8.0F,    256,  3, 1|2    |16   |64|128                  ,  64,   0,   0,   0,	"Fiery Steel"					,    5,    2048,       1811,21800,  true, false,   1,   1,   1, Dyes.dyeRed			, Arrays.asList(new TC_AspectStack(TC_Aspects.PRAECANTATIO, 3), new TC_AspectStack(TC_Aspects.IGNIS, 3), new TC_AspectStack(TC_Aspects.CORPUS, 3))),
	...
	Inolashite			( 954, TextureSet.SET_NONE				,   8.0F,   2304,  3, 1|2  |8|16      |64                   , 148, 216, 187,   0,	"Inolashite"					,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyeGreen		),
	...
	Naquadah			( 324, TextureSet.SET_METALLIC			,   6.0F,   1280,  4, 1|2  |8|16   |64                      ,  50,  50,  50,   0,	"Naquadah"						,    0,       0,       5400,25400,  true, false,  10,   1,   1, Dyes.dyeBlack		, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 3), new TC_AspectStack(TC_Aspects.RADIO, 1), new TC_AspectStack(TC_Aspects.NEBRISUM, 1))),
...
// 	RyuDragonRyder		(  -1, TextureSet.SET_NONE				,   1.0F,      0,  1, 0                                     , 255, 255, 255,   0,	"Ryu Dragon Ryder"				,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	...
	Vulcanite			( 489, TextureSet.SET_METALLIC			,   6.0F,     64,  2, 1|2  |8|16   |64|128                  , 255, 132,  72,   0,	"Vulcanite"						,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
	...
	Vinteum				( 529, TextureSet.SET_METALLIC			,  10.0F,    128,  3, 1|2  |8|16   |64|128                  , 100, 200, 255,   0,	"Vinteum"						,    5,      32,         -1,    0, false, false,   4,   1,   1, Dyes.dyeLightBlue	, 2, Arrays.asList(new MaterialStack(Thaumium, 1)), Arrays.asList(new TC_AspectStack(TC_Aspects.VITREUS, 2), new TC_AspectStack(TC_Aspects.PRAECANTATIO, 1))),
