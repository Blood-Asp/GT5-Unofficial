...
// 	RyuDragonRyder		(  -1, TextureSet.SET_NONE				,   1.0F,      0,  1, 0                                     , 255, 255, 255,   0,	"Ryu Dragon Ryder"				,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes._NULL			),
    ...
    Voidmetal           ( 970,  TextureSet.SET_METALLIC          ,  16.0F,    512,  4, 1|2          |64|128                 ,  28,   6,  57,   0,   "Void Metal"                    ,    5,    1500,         -1,    0, false, false,   5,   2,   1, Dyes.dyeBlack       , Arrays.asList(new TC_AspectStack(TC_Aspects.VACUOS, 1), new TC_AspectStack(TC_Aspects.VACUOS, 1))),
