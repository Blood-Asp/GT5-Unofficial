...
public class GT_MetaTileEntity_MagicalEnergyAbsorber extends GT_MetaTileEntity_BasicGenerator {
    ...
    public ITexture[] getFront(byte aColour) {
        return new ITexture[]{super.getFront(aColour)[0], new GT_RenderedTexture(Textures.BlockIcons.MACHINE_CASING_MAGIC),
    ...
    public ITexture[] getTop(byte aColour) {
        return new ITexture[]{super.getTop(aColour)[0], new GT_RenderedTexture(Textures.BlockIcons.MACHINE_CASING_DRAGONEGG)};
    }
    ...
    public ITexture[] getFrontActive(byte aColour) {
        return new ITexture[]{super.getFrontActive(aColour)[0], new GT_RenderedTexture(Textures.BlockIcons.MACHINE_CASING_MAGIC_ACTIVE),
                Textures.BlockIcons.OVERLAYS_ENERGY_OUT[this.mTier]};
    }
    ...
    public ITexture[] getTopActive(byte aColour) {
        return new ITexture[]{super.getTopActive(aColour)[0], new GT_RenderedTexture(Textures.BlockIcons.MACHINE_CASING_DRAGONEGG)};
    }
