...
public class GT_MetaTileEntity_MagicalEnergyAbsorber extends GT_MetaTileEntity_BasicGenerator {
    ...
    public static boolean PxssyMode = false; // if you use this... lame.
        ...
        if (aBaseMetaTileEntity.isServerSide() && aBaseMetaTileEntity.isAllowedToWork()
            ...
            if (isThaumcraftLoaded) {
                try {
                    ...
                    //System.out.println("Location of node:");
                    //System.out.println(tmpY);
                   ...
                   getBaseMetaTileEntity().increaseStoredEnergyUnits(Math.min(maxEUOutput(), visEU * getEfficiency() / sEnergyFromVis), false);
                    //getBaseMetaTileEntity().increaseStoredEnergyUnits(visEU, false); //NEVER USE THIS! this is debug
                    //thaum node = tile.blockAiry
                } catch (Throwable e) {
