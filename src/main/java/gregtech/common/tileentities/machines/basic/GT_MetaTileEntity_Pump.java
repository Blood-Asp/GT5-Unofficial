...
public class GT_MetaTileEntity_Pump extends GT_MetaTileEntity_Hatch {
    ...
    public GT_MetaTileEntity_Pump(int aID, String aName, String aNameRegional, int aTier) {
        super(aID, aName, aNameRegional, aTier, 3, new String[]{"The best way of emptying Oceans! Outputs on top.", "Pumping Area: " + (10 * ((int) Math.pow(1.6, aTier))) * 2 + 1 + "x" + (10 * ((int) Math.pow(1.6, aTier))) * 2 + 1});
    }
