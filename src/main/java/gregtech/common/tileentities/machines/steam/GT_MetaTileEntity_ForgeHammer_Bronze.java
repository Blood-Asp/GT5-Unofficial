...
public class GT_MetaTileEntity_ForgeHammer_Bronze
    ...
    public Object getClientGUI(int aID, InventoryPlayer aPlayerInventory, IGregTechTileEntity aBaseMetaTileEntity) {
        return new GT_GUIContainer_BasicMachine(aPlayerInventory, aBaseMetaTileEntity, getLocalName(), "BronzeHammer.png", GT_RecipeMap.sHammerRecipes.mUnlocalizedName, (byte) 6, (byte) 3);
    }

    public int checkRecipe() {
        GT_MachineRecipe tRecipe = GT_RecipeMap.sHammerRecipes.findRecipe(getBaseMetaTileEntity(), null, gregtech.api.enums.GT_Values.V[1], null, null, getAllInputs());
