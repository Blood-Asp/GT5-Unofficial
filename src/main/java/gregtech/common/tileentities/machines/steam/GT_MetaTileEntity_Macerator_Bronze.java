...
public class GT_MetaTileEntity_Macerator_Bronze
    ...
    public Object getClientGUI(int aID, InventoryPlayer aPlayerInventory, IGregTechTileEntity aBaseMetaTileEntity) {
        return new GT_GUIContainer_BasicMachine(aPlayerInventory, aBaseMetaTileEntity, getLocalName(), "BronzeMacerator.png", GT_RecipeMap.sMaceratorRecipes.mUnlocalizedName);
    }
    ...
    public int checkRecipe() {
        GT_RecipeMap tMap = GT_RecipeMap.sMaceratorRecipes;
        if (tMap == null) return DID_NOT_FIND_RECIPE;
        GT_MachineRecipe tRecipe = tMap.findRecipe(getBaseMetaTileEntity(), mLastRecipe, false, V[1], null, null, getAllInputs());
