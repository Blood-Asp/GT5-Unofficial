    ...
    int fluidIntoPower(ArrayList<FluidStack> aFluids, int aOptFlow, int aBaseEff) {
        ...
        for (int i = 0; i < aFluids.size() && remainingFlow > 0; i++) {
            ...
            if (fluidName.equals("ic2.fluidSuperheatedSteam")) {
                ...
                if (!achievement) {
                    GT_Mod.achievements.issueAchievement(this.getBaseMetaTileEntity().getWorldObj().getPlayerEntityByName(this.getBaseMetaTileEntity().getOwnerName()), "efficientsteam");
                    achievement = true;
                }
