...
public class GT_Tool_Shovel
    ...
    public boolean isMinableBlock(Block aBlock, byte aMetaData) {
        ...
        return (tTool == null || tTool.isEmpty() || (tTool.equals("shovel"))) || (aBlock.getMaterial() == Material.sand) || (aBlock.getMaterial() == Material.grass) || (aBlock.getMaterial() == Material.ground) || (aBlock.getMaterial() == Material.snow) || (aBlock.getMaterial() == Material.clay);
    }
