...
public class GT_Tool_Pickaxe
    ...
    public boolean isMinableBlock(Block aBlock, byte aMetaData) {
        ...
        return (tTool == null || tTool.isEmpty() || (tTool.equals("pickaxe"))) || (aBlock.getMaterial() == Material.rock) || (aBlock.getMaterial() == Material.iron) || (aBlock.getMaterial() == Material.anvil) || (aBlock.getMaterial() == Material.glass);
    }
