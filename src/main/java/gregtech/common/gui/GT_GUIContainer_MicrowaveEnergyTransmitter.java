    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        if (this.mContainer != null) {
            ...
            if (((GT_Container_MicrowaveEnergyTransmitter) this.mContainer).mEgg > 0) {
                ...
                this.fontRendererObj.drawString("Dim Valid: " + (DimensionManager.isDimensionRegistered(((GT_Container_MicrowaveEnergyTransmitter) this.mContainer).mTargetD) ? "Yes":"No"), 46, 48, 16448255);
            }
        }
    }
