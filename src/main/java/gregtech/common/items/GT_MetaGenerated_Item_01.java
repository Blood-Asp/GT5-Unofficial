...
public class GT_MetaGenerated_Item_01 extends GT_MetaGenerated_Item_X32 {
    ...
    public GT_MetaGenerated_Item_01() {
        ...
        ItemList.FluidRegulator_LuV.set(addItem(tLastID = 665, "Fluid Regulator (IV)", "Configuable up to 655.360 L/sec (as Cover)/n Rightclick/Screwdriver-rightclick/Shift-screwdriver-rightclick/n to adjust the pump speed by 1/16/256 L/sec per click", new Object[]{}));
        ItemList.FluidRegulator_ZPM.set(addItem(tLastID = 666, "Fluid Regulator (IV)", "Configuable up to 2.621.440 L/sec (as Cover)/n Rightclick/Screwdriver-rightclick/Shift-screwdriver-rightclick/n to adjust the pump speed by 1/16/256 L/sec per click", new Object[]{}));
        ItemList.FluidRegulator_UV.set(addItem(tLastID = 667, "Fluid Regulator (IV)", "Configuable up to 10.485.760 L/sec (as Cover)/n Rightclick/Screwdriver-rightclick/Shift-screwdriver-rightclick/n to adjust the pump speed by 1/16/256 L/sec per click", new Object[]{}));
