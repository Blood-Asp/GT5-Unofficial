...
public class GT_MetaGenerated_Item_01
    ...
    public GT_MetaGenerated_Item_01() {
        ...
        if (Loader.isModLoaded("GalacticraftMars")) {
            ...
            GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("GalacticraftCore", "item.heavyPlating", 1L), GT_OreDictUnificator.get(OrePrefixes.plant, Materials.MeteoricIron, 2L), Materials.Titanium.getMolten(72L), ItemList.Ingot_Heavy2.get(1L, new Object[0]), 600, 256);
